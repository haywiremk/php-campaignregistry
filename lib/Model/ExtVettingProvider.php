...
/**
 * ExtVettingProvider Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExtVettingProvider implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExtVettingProvider';
...
'display_name' => null,
'tcr_billable' => null,
'vetting_classes' => null,
'vetting_instruction' => null    ];
...
'tcr_billable' => 'tcrBillable',
'vetting_classes' => 'vettingClasses',
'vetting_instruction' => 'vettingInstruction'    ];
...
'tcr_billable' => 'setTcrBillable',
'vetting_classes' => 'setVettingClasses',
'vetting_instruction' => 'setVettingInstruction'    ];
...
'tcr_billable' => 'getTcrBillable',
'vetting_classes' => 'getVettingClasses',
'vetting_instruction' => 'getVettingInstruction'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tcr_billable'] = isset($data['tcr_billable']) ? $data['tcr_billable'] : null;
        $this->container['vetting_classes'] = isset($data['vetting_classes']) ? $data['vetting_classes'] : null;
        $this->container['vetting_instruction'] = isset($data['vetting_instruction']) ? $data['vetting_instruction'] : null;
    }
     ...
     * @return bool
     */
    public function getTcrBillable()
    {
        return $this->container['tcr_billable'];
    }

    /**
     * Sets tcr_billable
     *
     * @param bool $tcr_billable tcr_billable
     *
     * @return $this
     */
    public function setTcrBillable($tcr_billable)
    {
        $this->container['tcr_billable'] = $tcr_billable;

        return $this;
    }

    /**
     * Gets vetting_classes
     *
     * @return string[]
     */
    public function getVettingClasses()
    {
        return $this->container['vetting_classes'];
    }

    /**
     * Sets vetting_classes
     *
     * @param string[] $vetting_classes vetting_classes
     *
     * @return $this
     */
    public function setVettingClasses($vetting_classes)
    {
        $this->container['vetting_classes'] = $vetting_classes;

        return $this;
    }

    /**
     * Gets vetting_instruction
     *
     * @return string
     */
    public function getVettingInstruction()
    {
        return $this->container['vetting_instruction'];
    }

    /**
     * Sets vetting_instruction
     *
     * @param string $vetting_instruction vetting_instruction
     *
     * @return $this
     */
    public function setVettingInstruction($vetting_instruction)
    {
        $this->container['vetting_instruction'] = $vetting_instruction;
