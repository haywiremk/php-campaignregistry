 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Mno implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Mno';
...
'osr_bitmask_index' => 'osrBitmaskIndex'    ];
...
'osr_bitmask_index' => 'setOsrBitmaskIndex'    ];
...
'osr_bitmask_index' => 'getOsrBitmaskIndex'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['osr_bitmask_index'] = isset($data['osr_bitmask_index']) ? $data['osr_bitmask_index'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['osr_bitmask_index'] === null) {
            $invalidProperties[] = "'osr_bitmask_index' can't be null";
        }
     ...
     * Sets network_id
     *
     * @param int $network_id Unique network identifier assigned to MNO.
     *
     * @return $this
     */
     ...
     * Sets display_name
     *
     * @param string $display_name Display name of the mobile network operator.
     *
     * @return $this
     */
    ...
    /**
     * Gets osr_bitmask_index
     *
     * @return int
     */
    public function getOsrBitmaskIndex()
    {
        return $this->container['osr_bitmask_index'];
    }

    /**
     * Sets osr_bitmask_index
     *
     * @param int $osr_bitmask_index NetNumber OSR 'campaign_id' property's 'status' attribute holds individual MNO campaign operation status. The 'status' attribute leverages bitmasking technique to store multiple MNOs' operating status. The campaign operation status is reduced to '1' or '0' value where '1' indicate an 'ACTIVE' status and '0' represents every other non-active statuses, including REVIEW, REJECT and SUSPEND. The 'osrBitmaskIndex' holds the bitmask index of the MNO. For example, T-Mobile's bitmask index is 2, which implies T-Mobile's campaign operation status is stored in bit #2, or 3rd bit when counting from right.
     *
     * @return $this
     */
    public function setOsrBitmaskIndex($osr_bitmask_index)
    {
        $this->container['osr_bitmask_index'] = $osr_bitmask_index;
