...
'webhook_endpoint' => 'getWebhookEndpoint'    ];
    ...
    const EVENT_CATEGORY_API_ACCOUNT = 'API_ACCOUNT';
const EVENT_CATEGORY_BRAND = 'BRAND';
const EVENT_CATEGORY_CSP = 'CSP';
const EVENT_CATEGORY_CAMPAIGN = 'CAMPAIGN';
const EVENT_CATEGORY_INCIDENCE = 'INCIDENCE';
const EVENT_CATEGORY_DCA = 'DCA';
const EVENT_CATEGORY_CONNECTION = 'CONNECTION';
const EVENT_CATEGORY_TRAFFIC = 'TRAFFIC';
const EVENT_CATEGORY_ROUTING = 'ROUTING';
const EVENT_CATEGORY_PAYMENT = 'PAYMENT';
const EVENT_CATEGORY_VETTING = 'VETTING';
const EVENT_CATEGORY_RESELLER = 'RESELLER';
const EVENT_CATEGORY_OTHER = 'OTHER';
    ...
    {
        return [
            self::EVENT_CATEGORY_API_ACCOUNT,
self::EVENT_CATEGORY_BRAND,
self::EVENT_CATEGORY_CSP,
self::EVENT_CATEGORY_CAMPAIGN,
self::EVENT_CATEGORY_INCIDENCE,
self::EVENT_CATEGORY_DCA,
self::EVENT_CATEGORY_CONNECTION,
self::EVENT_CATEGORY_TRAFFIC,
self::EVENT_CATEGORY_ROUTING,
self::EVENT_CATEGORY_PAYMENT,
self::EVENT_CATEGORY_VETTING,
self::EVENT_CATEGORY_RESELLER,
self::EVENT_CATEGORY_OTHER,        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['webhook_endpoint'] = isset($data['webhook_endpoint']) ? $data['webhook_endpoint'] : null;
    }
     ...
     * Sets event_category
     *
     * @param string $event_category Use `/webhook/eventCategory` to retrieve events available for CSP
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getEventCategoryAllowableValues();
        if (!in_array($event_category, $allowedValues, true)) {
     ...
     *
     * @param string $webhook_endpoint Webhook endpoint to which the events subscribed will be notified
     *
     * @return $this
     */
