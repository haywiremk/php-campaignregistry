...
/**
 * UsecaseMetadata Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UsecaseMetadata implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UsecaseMetadata';
...
'mno_metadata' => 'map[string,\TCR\Client\Model\Metadata]'    ];
...
'quarterly_fee' => null,
'annual_fee' => null,
'min_sub_usecases' => 'int32',
'max_sub_usecases' => 'int32',
'mno_metadata' => null    ];
...
'mno_metadata' => 'getMnoMetadata'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['quarterly_fee'] = isset($data['quarterly_fee']) ? $data['quarterly_fee'] : null;
        $this->container['annual_fee'] = isset($data['annual_fee']) ? $data['annual_fee'] : null;
        $this->container['min_sub_usecases'] = isset($data['min_sub_usecases']) ? $data['min_sub_usecases'] : null;
        $this->container['max_sub_usecases'] = isset($data['max_sub_usecases']) ? $data['max_sub_usecases'] : null;
        $this->container['mno_metadata'] = isset($data['mno_metadata']) ? $data['mno_metadata'] : null;
    }
     ...
     * Sets usecase
     *
     * @param string $usecase Campaign usecase
     *
     * @return $this
     */
     ...
     * Sets monthly_fee
     *
     * @param float $monthly_fee Campaign monthly subscription fee
     *
     * @return $this
     */
    ...
    {
        return $this->container['quarterly_fee'];
    }

    /**
     * Sets quarterly_fee
     *
     * @param float $quarterly_fee Campaign quarterly subscription fee
     *
     * @return $this
     */
    public function setQuarterlyFee($quarterly_fee)
    {
        $this->container['quarterly_fee'] = $quarterly_fee;
     ...
     * Sets annual_fee
     *
     * @param float $annual_fee Campaign annual subscription fee
     *
     * @return $this
     */
     ...
     *
     * @param int $min_sub_usecases Minimum number of sub-usecases declaration required.
     *
     * @return $this
     */
     ...
     *
     * @param int $max_sub_usecases Maximum number of sub-usecases declaration required.
     *
     * @return $this
     */
     ...
     * Gets mno_metadata
     *
     * @return map[string,\TCR\Client\Model\Metadata]
     */
    public function getMnoMetadata()
    {
        return $this->container['mno_metadata'];
    }

    /**
     * Sets mno_metadata
     *
     * @param map[string,\TCR\Client\Model\Metadata] $mno_metadata Map of usecase metadata for each MNO. Key is the network ID of the MNO (e.g. 10017), Value is the mno metadata for the usecase.
     *
     * @return $this
     */
    public function setMnoMetadata($mno_metadata)
    {
        $this->container['mno_metadata'] = $mno_metadata;
