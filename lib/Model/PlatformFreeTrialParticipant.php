...
/**
 * PlatformFreeTrialParticipant Class Doc Comment
 *
 * @category Class
 * @description Provisioning record of user participating in a platform free trial program.
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PlatformFreeTrialParticipant implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PlatformFreeTrialParticipant';
...
'email' => 'string',
'longcode' => 'string',
'longcode_provision_date' => '\DateTime',
...
'email' => null,
'longcode' => null,
'longcode_provision_date' => 'date-time',
...
'email' => 'email',
'longcode' => 'longcode',
'longcode_provision_date' => 'longcodeProvisionDate',
...
'longcode_provision_date' => 'setLongcodeProvisionDate',
...
'longcode_provision_date' => 'getLongcodeProvisionDate',
'create_date' => 'getCreateDate'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['longcode'] = isset($data['longcode']) ? $data['longcode'] : null;
        $this->container['longcode_provision_date'] = isset($data['longcode_provision_date']) ? $data['longcode_provision_date'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['longcode_provision_date'] === null) {
            $invalidProperties[] = "'longcode_provision_date' can't be null";
        }
     ...
     * Sets reseller_id
     *
     * @param string $reseller_id If this is an ISV trial program, then the ISV must be identified by its reseller ID.
     *
     * @return $this
     */
     ...
     * Sets reference_id
     *
     * @param string $reference_id Trial participant account ID that can be used to uniquely identify the participanting trial user in the CSP platform.
     *
     * @return $this
     */
     ...
     * Sets first_name
     *
     * @param string $first_name First or given name of the user.
     *
     * @return $this
     */
     ...
     * Sets last_name
     *
     * @param string $last_name Last or surname of the user.
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string $email Valid contact email address.
     *
     * @return $this
     */
     ...
     * Sets longcode
     *
     * @param string $longcode Valid phone number in e.164 international format.
     *
     * @return $this
     */
    ...
    /**
     * Gets longcode_provision_date
     *
     * @return \DateTime
     */
    public function getLongcodeProvisionDate()
    {
        return $this->container['longcode_provision_date'];
    }

    /**
     * Sets longcode_provision_date
     *
     * @param \DateTime $longcode_provision_date The timestamp when the 10DLC longcode was assigned to the user.
     *
     * @return $this
     */
    public function setLongcodeProvisionDate($longcode_provision_date)
    {
        $this->container['longcode_provision_date'] = $longcode_provision_date;
     ...
     * Sets create_date
     *
     * @param \DateTime $create_date The timestamp when the record was reported by the CSP.
     *
     * @return $this
     */
