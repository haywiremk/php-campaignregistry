<?php
/**
 * ExternalVettingMockCvTokenBody
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ExternalVettingMockCvTokenBody Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExternalVettingMockCvTokenBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'externalVetting_mockCvToken_body';
...
'valid_until' => 'getValidUntil'    ];
    ...
    const LOCALE_FEDERAL = 'federal';
const LOCALE_STATE = 'state';
const LOCALE_LOCAL = 'local';
const LOCALE_TRIBAL = 'tribal';
...
self::LOCALE_TRIBAL,        ];
     ...
     * Sets valid_until
     *
     * @param string $valid_until Token valid until in yyyy-MM-dd format
     *
     * @return $this
     */
