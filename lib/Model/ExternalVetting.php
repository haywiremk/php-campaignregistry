...
/**
 * ExternalVetting Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExternalVetting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExternalVetting';
...
'reasons' => 'string[]',
'vetting_details' => 'map[string,object]',
'vetted_date' => '\DateTime',
...
'vetting_status' => null,
'reasons' => null,
'vetting_details' => null,
'vetted_date' => 'date-time',
...
'create_date' => 'createDate'    ];
    ...
    protected static $setters = [
        'evp_id' => 'setEvpId',
'vetting_id' => 'setVettingId',
'vetting_token' => 'setVettingToken',
'vetting_score' => 'setVettingScore',
'vetting_class' => 'setVettingClass',
'vetting_status' => 'setVettingStatus',
'reasons' => 'setReasons',
'vetting_details' => 'setVettingDetails',
'vetted_date' => 'setVettedDate',
'create_date' => 'setCreateDate'    ];
    ...
    protected static $getters = [
        'evp_id' => 'getEvpId',
'vetting_id' => 'getVettingId',
'vetting_token' => 'getVettingToken',
'vetting_score' => 'getVettingScore',
'vetting_class' => 'getVettingClass',
'vetting_status' => 'getVettingStatus',
'reasons' => 'getReasons',
'vetting_details' => 'getVettingDetails',
'vetted_date' => 'getVettedDate',
...
const VETTING_STATUS_UNSCORE = 'UNSCORE';
const VETTING_STATUS_ACTIVE = 'ACTIVE';
const VETTING_STATUS_FAILED = 'FAILED';
const VETTING_STATUS_EXPIRED = 'EXPIRED';
     ...
     * @return string[]
     */
    public function getVettingStatusAllowableValues()
    {
        return [
            self::VETTING_STATUS_PENDING,
self::VETTING_STATUS_UNSCORE,
self::VETTING_STATUS_ACTIVE,
self::VETTING_STATUS_FAILED,
self::VETTING_STATUS_EXPIRED,        ];
    }
    ...
    {
        $this->container['evp_id'] = isset($data['evp_id']) ? $data['evp_id'] : null;
        $this->container['vetting_id'] = isset($data['vetting_id']) ? $data['vetting_id'] : null;
        $this->container['vetting_token'] = isset($data['vetting_token']) ? $data['vetting_token'] : null;
        $this->container['vetting_score'] = isset($data['vetting_score']) ? $data['vetting_score'] : null;
        $this->container['vetting_class'] = isset($data['vetting_class']) ? $data['vetting_class'] : null;
        $this->container['vetting_status'] = isset($data['vetting_status']) ? $data['vetting_status'] : null;
        $this->container['reasons'] = isset($data['reasons']) ? $data['reasons'] : null;
        $this->container['vetting_details'] = isset($data['vetting_details']) ? $data['vetting_details'] : null;
        $this->container['vetted_date'] = isset($data['vetted_date']) ? $data['vetted_date'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getVettingStatusAllowableValues();
        if (!is_null($this->container['vetting_status']) && !in_array($this->container['vetting_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'vetting_status', must be one of '%s'",
     ...
     * @return string
     */
    public function getEvpId()
    {
        return $this->container['evp_id'];
    }

    /**
     * Sets evp_id
     *
     * @param string $evp_id External vetting provider ID for the brand.
     *
     * @return $this
     */
    public function setEvpId($evp_id)
    {
        $this->container['evp_id'] = $evp_id;
     ...
     * @return string
     */
    public function getVettingId()
    {
        return $this->container['vetting_id'];
    }

    /**
     * Sets vetting_id
     *
     * @param string $vetting_id Unique ID that identifies a vetting transaction performed by a vetting provider. This ID is provided by the vetting provider at time of vetting.
     *
     * @return $this
     */
    public function setVettingId($vetting_id)
    {
        $this->container['vetting_id'] = $vetting_id;
     ...
     * @return string
     */
    public function getVettingToken()
    {
        return $this->container['vetting_token'];
    }

    /**
     * Sets vetting_token
     *
     * @param string $vetting_token Required by some providers for vetting record confirmation.
     *
     * @return $this
     */
    public function setVettingToken($vetting_token)
    {
        $this->container['vetting_token'] = $vetting_token;
     ...
     * @return int
     */
    public function getVettingScore()
    {
        return $this->container['vetting_score'];
    }

    /**
     * Sets vetting_score
     *
     * @param int $vetting_score Vetting score ranging from 0-100.
     *
     * @return $this
     */
    public function setVettingScore($vetting_score)
    {
        $this->container['vetting_score'] = $vetting_score;
     ...
     * @return string
     */
    public function getVettingClass()
    {
        return $this->container['vetting_class'];
    }

    /**
     * Sets vetting_class
     *
     * @param string $vetting_class Identifies the vetting classification.
     *
     * @return $this
     */
    public function setVettingClass($vetting_class)
    {
        $this->container['vetting_class'] = $vetting_class;
    ...
    {
        return $this->container['vetting_status'];
    }

    /**
     * Sets vetting_status
     *
     * @param string $vetting_status Identifies the vetting request status.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getVettingStatusAllowableValues();
        if (!is_null($vetting_status) && !in_array($vetting_status, $allowedValues, true)) {
        ...
        $this->container['vetting_status'] = $vetting_status;
     ...
     * Sets reasons
     *
     * @param string[] $reasons The List of causes for FAILED ExternalVetting.
     *
     * @return $this
     */
    ...
    /**
     * Gets vetting_details
     *
     * @return map[string,object]
     */
    public function getVettingDetails()
    {
        return $this->container['vetting_details'];
    }

    /**
     * Sets vetting_details
     *
     * @param map[string,object] $vetting_details Vetting provider specific details.
     *
     * @return $this
     */
    public function setVettingDetails($vetting_details)
    {
        $this->container['vetting_details'] = $vetting_details;
     ...
     * @return \DateTime
     */
    public function getVettedDate()
    {
        return $this->container['vetted_date'];
    }

    /**
     * Sets vetted_date
     *
     * @param \DateTime $vetted_date Vetting effective date. This is the date when vetting was completed, or the starting effective date in ISO 8601 format. If this date is missing, then the vetting was not complete or not valid.
     *
     * @return $this
     */
    public function setVettedDate($vetted_date)
    {
        $this->container['vetted_date'] = $vetted_date;
     ...
     * Sets create_date
     *
     * @param \DateTime $create_date Vetting submission date. This is the date when the vetting request is generated in ISO 8601 format.
     *
     * @return $this
     */
