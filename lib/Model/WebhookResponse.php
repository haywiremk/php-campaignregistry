...
'response' => 'getResponse'    ];
     ...
     * Sets endpoint
     *
     * @param string $endpoint The webhook subscription endpoint
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param int $status HTTP Response status code returned by your webhook endpoint
     *
     * @return $this
     */
     ...
     * Sets request
     *
     * @param string $request The webhook payload submitted to your endpoint
     *
     * @return $this
     */
     ...
     * Sets response
     *
     * @param string $response HTTP Response returned by your webhook endpoint
     *
     * @return $this
     */
