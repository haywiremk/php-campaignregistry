...
/**
 * BrandRecordSetCSP Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BrandRecordSetCSP implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BrandRecordSet_CSP';
    ...
    protected static $swaggerTypes = [
        'records' => '\TCR\Client\Model\BrandCSP[]',
'page' => 'int',
'total_records' => 'int'    ];
...
'total_records' => 'getTotalRecords'    ];
     ...
     * Sets records
     *
     * @param \TCR\Client\Model\BrandCSP[] $records records
     *
     * @return $this
     */
