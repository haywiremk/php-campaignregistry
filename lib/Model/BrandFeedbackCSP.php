...
/**
 * BrandFeedbackCSP Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BrandFeedbackCSP implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BrandFeedback_CSP';
    ...
    protected static $swaggerTypes = [
        'brand_id' => 'string',
'category' => '\TCR\Client\Model\FeedbackCategoryCSP[]'    ];
...
'category' => 'getCategory'    ];
     ...
     * Gets category
     *
     * @return \TCR\Client\Model\FeedbackCategoryCSP[]
     */
     ...
     * Sets category
     *
     * @param \TCR\Client\Model\FeedbackCategoryCSP[] $category category
     *
     * @return $this
     */
