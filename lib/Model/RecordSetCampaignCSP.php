...
/**
 * RecordSetCampaignCSP Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RecordSetCampaignCSP implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RecordSetCampaign_CSP';
    ...
    protected static $swaggerTypes = [
        'records' => '\TCR\Client\Model\CampaignCSP[]',
'page' => 'int',
'total_records' => 'int'    ];
...
'total_records' => 'getTotalRecords'    ];
     ...
     * Sets records
     *
     * @param \TCR\Client\Model\CampaignCSP[] $records records
     *
     * @return $this
     */
