...
/**
 * CampaignSubmissionResponse Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CampaignSubmissionResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CampaignSubmissionResponse';
...
'mno_metadata' => 'getMnoMetadata'    ];
     ...
     * Sets mno_metadata
     *
     * @param map[string,\TCR\Client\Model\Metadata] $mno_metadata Map of key (MNO network identifier) to value (MNO campaign metadata).
     *
     * @return $this
     */
