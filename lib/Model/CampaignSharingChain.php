...
/**
 * CampaignSharingChain Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CampaignSharingChain implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CampaignSharingChain';
    ...
    protected static $swaggerTypes = [
        'shared_with_me' => '\TCR\Client\Model\CampaignSharingStatus',
'shared_by_me' => '\TCR\Client\Model\CampaignSharingStatus'    ];
...
'shared_by_me' => 'getSharedByMe'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['shared_by_me'] = isset($data['shared_by_me']) ? $data['shared_by_me'] : null;
    }
     ...
     * Sets shared_with_me
     *
     * @param \TCR\Client\Model\CampaignSharingStatus $shared_with_me shared_with_me
     *
     * @return $this
     */
    ...
    {
        return $this->container['shared_by_me'];
    }

    /**
     * Sets shared_by_me
     *
     * @param \TCR\Client\Model\CampaignSharingStatus $shared_by_me shared_by_me
     *
     * @return $this
     */
    public function setSharedByMe($shared_by_me)
    {
        $this->container['shared_by_me'] = $shared_by_me;
