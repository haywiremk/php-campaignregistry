...
/**
 * CampaignSharingStatus Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CampaignSharingStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CampaignSharingStatus';
...
'status_date' => '\DateTime'    ];
    ...
    protected static $swaggerFormats = [
        'downstream_cnp_id' => null,
'upstream_cnp_id' => null,
'sharing_status' => null,
'shared_date' => 'date-time',
'status_date' => 'date-time'    ];
    ...
    protected static $attributeMap = [
        'downstream_cnp_id' => 'downstreamCnpId',
'upstream_cnp_id' => 'upstreamCnpId',
...
'status_date' => 'statusDate'    ];
    ...
    protected static $setters = [
        'downstream_cnp_id' => 'setDownstreamCnpId',
'upstream_cnp_id' => 'setUpstreamCnpId',
'sharing_status' => 'setSharingStatus',
'shared_date' => 'setSharedDate',
'status_date' => 'setStatusDate'    ];
    ...
    protected static $getters = [
        'downstream_cnp_id' => 'getDownstreamCnpId',
'upstream_cnp_id' => 'getUpstreamCnpId',
'sharing_status' => 'getSharingStatus',
'shared_date' => 'getSharedDate',
'status_date' => 'getStatusDate'    ];
    ...
    const SHARING_STATUS_PENDING = 'PENDING';
const SHARING_STATUS_ACCEPTED = 'ACCEPTED';
const SHARING_STATUS_DECLINED = 'DECLINED';
    ...
    {
        return [
            self::SHARING_STATUS_PENDING,
self::SHARING_STATUS_ACCEPTED,
self::SHARING_STATUS_DECLINED,        ];
    }
    ...
    {
        $this->container['downstream_cnp_id'] = isset($data['downstream_cnp_id']) ? $data['downstream_cnp_id'] : null;
        $this->container['upstream_cnp_id'] = isset($data['upstream_cnp_id']) ? $data['upstream_cnp_id'] : null;
        $this->container['sharing_status'] = isset($data['sharing_status']) ? $data['sharing_status'] : null;
        $this->container['shared_date'] = isset($data['shared_date']) ? $data['shared_date'] : null;
    ...
    /**
     * Gets downstream_cnp_id
     *
     * @return string
     */
    public function getDownstreamCnpId()
    {
        return $this->container['downstream_cnp_id'];
    }

    /**
     * Sets downstream_cnp_id
     *
     * @param string $downstream_cnp_id downstream_cnp_id
     *
     * @return $this
     */
    public function setDownstreamCnpId($downstream_cnp_id)
    {
        $this->container['downstream_cnp_id'] = $downstream_cnp_id;

        return $this;
    }

    /**
     * Gets upstream_cnp_id
     *
     * @return string
     */
    public function getUpstreamCnpId()
    {
        return $this->container['upstream_cnp_id'];
    }

    /**
     * Sets upstream_cnp_id
     *
     * @param string $upstream_cnp_id upstream_cnp_id
     *
     * @return $this
     */
    public function setUpstreamCnpId($upstream_cnp_id)
    {
        $this->container['upstream_cnp_id'] = $upstream_cnp_id;
     ...
     * Sets sharing_status
     *
     * @param string $sharing_status sharing_status
     *
     * @return $this
     */
    ...
    {
        return $this->container['shared_date'];
    }

    /**
     * Sets shared_date
     *
     * @param \DateTime $shared_date shared_date
     *
     * @return $this
     */
    public function setSharedDate($shared_date)
    {
        $this->container['shared_date'] = $shared_date;
