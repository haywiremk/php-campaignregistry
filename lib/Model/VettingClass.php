...
/**
 * VettingClass Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VettingClass implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VettingClass';
...
'validity_months' => 'getValidityMonths'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['validity_months'] = isset($data['validity_months']) ? $data['validity_months'] : null;
    }
     ...
     *
     * @param int $validity_months validity_months
     *
     * @return $this
     */
