...
/**
 * ResellerRecordSet Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResellerRecordSet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResellerRecordSet';
    ...
    protected static $swaggerTypes = [
        'records' => '\TCR\Client\Model\Reseller[]',
'page' => 'int',
'total_records' => 'int'    ];
...
'total_records' => 'getTotalRecords'    ];
     ...
     * Sets records
     *
     * @param \TCR\Client\Model\Reseller[] $records records
     *
     * @return $this
     */
