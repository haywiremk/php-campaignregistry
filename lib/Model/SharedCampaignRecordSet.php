...
/**
 * SharedCampaignRecordSet Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SharedCampaignRecordSet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SharedCampaignRecordSet';
    ...
    protected static $swaggerTypes = [
        'records' => '\TCR\Client\Model\SharedCampaign[]',
'page' => 'int',
'total_records' => 'int'    ];
...
'total_records' => 'getTotalRecords'    ];
     ...
     * Sets records
     *
     * @param \TCR\Client\Model\SharedCampaign[] $records records
     *
     * @return $this
     */
