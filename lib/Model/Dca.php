 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Dca implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Dca';
...
'display_name' => 'getDisplayName'    ];
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the direct connect aggregator
     *
     * @return $this
     */
     ...
     * Sets display_name
     *
     * @param string $display_name Display name of the direct connect aggregator.
     *
     * @return $this
     */
