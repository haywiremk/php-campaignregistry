...
/**
 * TagRecordSetCSP Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TagRecordSetCSP implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TagRecordSet_CSP';
    ...
    protected static $swaggerTypes = [
        'records' => '\TCR\Client\Model\TagCSP[]',
'page' => 'int',
'total_records' => 'int'    ];
...
'total_records' => 'getTotalRecords'    ];
     ...
     * Gets records
     *
     * @return \TCR\Client\Model\TagCSP[]
     */
     ...
     * Sets records
     *
     * @param \TCR\Client\Model\TagCSP[] $records records
     *
     * @return $this
     */
