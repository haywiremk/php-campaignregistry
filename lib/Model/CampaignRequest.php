...
'affiliate_marketing' => 'getAffiliateMarketing'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['age_gated'] = isset($data['age_gated']) ? $data['age_gated'] : false;
        $this->container['direct_lending'] = isset($data['direct_lending']) ? $data['direct_lending'] : false;
        ...
        $this->container['mno_ids'] = isset($data['mno_ids']) ? $data['mno_ids'] : null;
        $this->container['reference_id'] = isset($data['reference_id']) ? $data['reference_id'] : null;
        $this->container['auto_renewal'] = isset($data['auto_renewal']) ? $data['auto_renewal'] : true;
        $this->container['tag'] = isset($data['tag']) ? $data['tag'] : null;
        $this->container['affiliate_marketing'] = isset($data['affiliate_marketing']) ? $data['affiliate_marketing'] : false;
    }
     ...
     * Sets age_gated
     *
     * @param bool $age_gated Age gated message content in campaign.
     *
     * @return $this
     */
     ...
     * Sets direct_lending
     *
     * @param bool $direct_lending Direct lending or loan arrangement
     *
     * @return $this
     */
     ...
     * @return int[]
     */
    public function getMnoIds()
    {
        return $this->container['mno_ids'];
    }

    /**
     * Sets mno_ids
     *
     * @param int[] $mno_ids Submit campaign to given list of MNOs by MNO's network ID. Default is all MNOs if no value provided.
     *
     * @return $this
     */
    public function setMnoIds($mno_ids)
    {
        $this->container['mno_ids'] = $mno_ids;
     ...
     * Sets auto_renewal
     *
     * @param bool $auto_renewal Campaign subscription auto-renewal option. If set to true, then campaign will automatically renewal at end of billing cycle.
     *
     * @return $this
     */
     ...
     * Sets tag
     *
     * @param string[] $tag Tags to be set on the Campaign.
     *
     * @return $this
     */
