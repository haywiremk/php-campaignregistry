...
/**
 * ExternalVettingImportRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExternalVettingImportRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExternalVettingImportRequest';
...
'vetting_token' => 'getVettingToken'    ];
     ...
     * Sets evp_id
     *
     * @param string $evp_id External vetting provider ID recognized by TCR. Use API endpoint /enum/extVettingProvider to view list of supported vetting providers.
     *
     * @return $this
     */
