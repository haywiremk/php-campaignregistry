 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TagCSP implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Tag_CSP';
...
'record_id' => 'getRecordId'    ];
    ...
    const RECORD_TYPE_BRAND = 'BRAND';
const RECORD_TYPE_CAMPAIGN = 'CAMPAIGN';
...
self::RECORD_TYPE_CAMPAIGN,        ];
     ...
     * Sets name
     *
     * @param string $name Name of the tag. Case-insensitive. Space and puncuation not allowed
     *
     * @return $this
     */
     ...
     * Sets record_type
     *
     * @param string $record_type Type of record. Options: BRAND or CAMPAIGN
     *
     * @return $this
     */
     ...
     * Sets record_id
     *
     * @param string $record_id ID of the brand or campaign.
     *
     * @return $this
     */
