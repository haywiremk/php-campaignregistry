 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BrandRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BrandRequest';
...
self::ALT_BUSINESS_ID_TYPE_LEI,        ];
     ...
     * Sets first_name
     *
     * @param string $first_name First or given name. Applicable to SOLE_PROPRIETOR entity type.
     *
     * @return $this
     */
     ...
     * Sets last_name
     *
     * @param string $last_name Last or Surname. Applicable to SOLE_PROPRIETOR entity type.
     *
     * @return $this
     */
     ...
     * Sets vertical
     *
     * @param string $vertical (Required for all entity types except sole proprietor) vertical or industry segment of the brand.
     *
     * @return $this
     */
     ...
     * Sets mock
     *
     * @param bool $mock If true, marks the brand as a test brand that does not incur a billable charge on brand subsequent campaign registration.
     *
     * @return $this
     */
     ...
     * Sets tag
     *
     * @param string[] $tag Tags to be set on the Brand.
     *
     * @return $this
     */
