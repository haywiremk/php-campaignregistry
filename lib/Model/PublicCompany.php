...
/**
 * PublicCompany Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PublicCompany implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PublicCompany';
...
'display_name' => 'getDisplayName'    ];
    ...
    const EXCHANGE_NONE = 'NONE';
const EXCHANGE_NASDAQ = 'NASDAQ';
const EXCHANGE_NYSE = 'NYSE';
const EXCHANGE_AMEX = 'AMEX';
const EXCHANGE_AMX = 'AMX';
const EXCHANGE_ASX = 'ASX';
const EXCHANGE_B3 = 'B3';
const EXCHANGE_BME = 'BME';
const EXCHANGE_BSE = 'BSE';
const EXCHANGE_FRA = 'FRA';
const EXCHANGE_ICEX = 'ICEX';
const EXCHANGE_JPX = 'JPX';
const EXCHANGE_JSE = 'JSE';
const EXCHANGE_KRX = 'KRX';
const EXCHANGE_LON = 'LON';
const EXCHANGE_NSE = 'NSE';
const EXCHANGE_OMX = 'OMX';
const EXCHANGE_SEHK = 'SEHK';
const EXCHANGE_SGX = 'SGX';
const EXCHANGE_SSE = 'SSE';
const EXCHANGE_STO = 'STO';
const EXCHANGE_SWX = 'SWX';
const EXCHANGE_SZSE = 'SZSE';
const EXCHANGE_TSX = 'TSX';
const EXCHANGE_TWSE = 'TWSE';
const EXCHANGE_VSE = 'VSE';
const EXCHANGE_OTHER = 'OTHER';
