...
/**
 * CampaignBuilderApi Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
...
class CampaignBuilderApi
{
     ...
     * @return \TCR\Client\Model\UsecaseMetadata[]
     */
    public function qualifyAllUsecases($brand_id)
    {
        list($response) = $this->qualifyAllUsecasesWithHttpInfo($brand_id);
        return $response;
    }

    /**
     * Operation qualifyAllUsecasesWithHttpInfo
     *
     * Campaign builder Step 1: Qualify brand for all usecases
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\UsecaseMetadata[], HTTP status code, HTTP response headers (array of strings)
     */
    public function qualifyAllUsecasesWithHttpInfo($brand_id)
    {
        $returnType = '\TCR\Client\Model\UsecaseMetadata[]';
        $request = $this->qualifyAllUsecasesRequest($brand_id);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TCR\Client\Model\UsecaseMetadata[]',
    ...
    /**
     * Operation qualifyAllUsecasesAsync
     *
     * Campaign builder Step 1: Qualify brand for all usecases
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     ...
     */
    public function qualifyAllUsecasesAsync($brand_id)
    {
        return $this->qualifyAllUsecasesAsyncWithHttpInfo($brand_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation qualifyAllUsecasesAsyncWithHttpInfo
     *
     * Campaign builder Step 1: Qualify brand for all usecases
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function qualifyAllUsecasesAsyncWithHttpInfo($brand_id)
    {
        $returnType = '\TCR\Client\Model\UsecaseMetadata[]';
        $request = $this->qualifyAllUsecasesRequest($brand_id);
    ...
    /**
     * Create request for operation 'qualifyAllUsecases'
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function qualifyAllUsecasesRequest($brand_id)
    {
        // verify the required parameter 'brand_id' is set
        if ($brand_id === null || (is_array($brand_id) && count($brand_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $brand_id when calling qualifyAllUsecases'
            );
        }

        $resourcePath = '/campaignBuilder/brand/{brandId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation qualifyByUsecase
     *
     * Campaign builder Step 1: Qualify brand by usecase
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     * @param  string $usecase Campaign usecase. E.g. 2FA (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function qualifyByUsecase($brand_id, $usecase)
    {
        list($response) = $this->qualifyByUsecaseWithHttpInfo($brand_id, $usecase);
        return $response;
    }

    /**
     * Operation qualifyByUsecaseWithHttpInfo
     *
     * Campaign builder Step 1: Qualify brand by usecase
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     ...
     */
    public function qualifyByUsecaseWithHttpInfo($brand_id, $usecase)
    {
        $returnType = 'object';
        $request = $this->qualifyByUsecaseRequest($brand_id, $usecase);
    ...
    /**
     * Operation qualifyByUsecaseAsync
     *
     * Campaign builder Step 1: Qualify brand by usecase
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function qualifyByUsecaseAsync($brand_id, $usecase)
    {
        return $this->qualifyByUsecaseAsyncWithHttpInfo($brand_id, $usecase)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation qualifyByUsecaseAsyncWithHttpInfo
     *
     * Campaign builder Step 1: Qualify brand by usecase
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function qualifyByUsecaseAsyncWithHttpInfo($brand_id, $usecase)
    {
        $returnType = 'object';
        $request = $this->qualifyByUsecaseRequest($brand_id, $usecase);
    ...
    /**
     * Create request for operation 'qualifyByUsecase'
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     * @param  string $usecase Campaign usecase. E.g. 2FA (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function qualifyByUsecaseRequest($brand_id, $usecase)
    {
        // verify the required parameter 'brand_id' is set
        if ($brand_id === null || (is_array($brand_id) && count($brand_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $brand_id when calling qualifyByUsecase'
            );
        }
        // verify the required parameter 'usecase' is set
        if ($usecase === null || (is_array($usecase) && count($usecase) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $usecase when calling qualifyByUsecase'
            );
        }

        $resourcePath = '/campaignBuilder/brand/{brandId}/usecase/{usecase}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($usecase !== null) {
            $resourcePath = str_replace(
                '{' . 'usecase' . '}',
                ObjectSerializer::toPathValue($usecase),
                $resourcePath
            );
        }
    ...
    /**
     * Operation submitCampaign
     *
     * Campaign builder Step 2: Create new campaign
     *
     * @param  \TCR\Client\Model\CampaignRequest $body Campaign request to be submitted (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function submitCampaign($body)
    {
        list($response) = $this->submitCampaignWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation submitCampaignWithHttpInfo
     *
     * Campaign builder Step 2: Create new campaign
     *
     * @param  \TCR\Client\Model\CampaignRequest $body Campaign request to be submitted (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitCampaignWithHttpInfo($body)
    {
        $returnType = 'object';
        $request = $this->submitCampaignRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function submitCampaignAsync($body)
    {
        return $this->submitCampaignAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation submitCampaignAsyncWithHttpInfo
     *
     * Campaign builder Step 2: Create new campaign
     *
     * @param  \TCR\Client\Model\CampaignRequest $body Campaign request to be submitted (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function submitCampaignAsyncWithHttpInfo($body)
    {
        $returnType = 'object';
        $request = $this->submitCampaignRequest($body);
    ...
    /**
     * Create request for operation 'submitCampaign'
     *
     * @param  \TCR\Client\Model\CampaignRequest $body Campaign request to be submitted (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function submitCampaignRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling submitCampaign'
            );
        }

        $resourcePath = '/campaignBuilder';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
