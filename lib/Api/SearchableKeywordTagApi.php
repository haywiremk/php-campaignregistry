...
/**
 * SearchableKeywordTagApi Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
...
class SearchableKeywordTagApi
{
     ...
     * @param  string $record_type Record type (required)
     ...
     * @return void
     */
    public function deleteTag($name, $record_type, $record_id)
    {
        $this->deleteTagWithHttpInfo($name, $record_type, $record_id);
    }
     ...
     */
    public function deleteTagWithHttpInfo($name, $record_type, $record_id)
    {
        $returnType = '';
        $request = $this->deleteTagRequest($name, $record_type, $record_id);
     ...
     */
    public function deleteTagAsync($name, $record_type, $record_id)
    {
        return $this->deleteTagAsyncWithHttpInfo($name, $record_type, $record_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTagAsyncWithHttpInfo($name, $record_type, $record_id)
    {
        $returnType = '';
        $request = $this->deleteTagRequest($name, $record_type, $record_id);
     ...
     */
    protected function deleteTagRequest($name, $record_type, $record_id)
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling deleteTag'
            );
        }
        // verify the required parameter 'record_type' is set
        if ($record_type === null || (is_array($record_type) && count($record_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $record_type when calling deleteTag'
            );
        }
        // verify the required parameter 'record_id' is set
        if ($record_id === null || (is_array($record_id) && count($record_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $record_id when calling deleteTag'
            );
        }

        $resourcePath = '/tag/name/{name}/recordType/{recordType}/recordId/{recordId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $record_id Record ID for brand or campaign (optional)
     * @param  string $record_type Record type (optional)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\TagRecordSetCSP
     */
    public function search($name = null, $record_id = null, $record_type = null, $page = '1', $records_per_page = '10')
    {
        list($response) = $this->searchWithHttpInfo($name, $record_id, $record_type, $page, $records_per_page);
        return $response;
    }
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\TagRecordSetCSP, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($name = null, $record_id = null, $record_type = null, $page = '1', $records_per_page = '10')
    {
        $returnType = '\TCR\Client\Model\TagRecordSetCSP';
        $request = $this->searchRequest($name, $record_id, $record_type, $page, $records_per_page);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TCR\Client\Model\TagRecordSetCSP',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($name = null, $record_id = null, $record_type = null, $page = '1', $records_per_page = '10')
    {
        return $this->searchAsyncWithHttpInfo($name, $record_id, $record_type, $page, $records_per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($name = null, $record_id = null, $record_type = null, $page = '1', $records_per_page = '10')
    {
        $returnType = '\TCR\Client\Model\TagRecordSetCSP';
        $request = $this->searchRequest($name, $record_id, $record_type, $page, $records_per_page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($name = null, $record_id = null, $record_type = null, $page = '1', $records_per_page = '10')
    {
        ...
        // query params
        if ($record_type !== null) {
            $queryParams['recordType'] = ObjectSerializer::toQueryValue($record_type, null);
        }
        // query params
        if ($page !== null) {
     ...
     *
     * @param  \TCR\Client\Model\Tag $body Tagging object (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\Tag
     */
    public function setTag($body)
    {
        list($response) = $this->setTagWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation setTagWithHttpInfo
     *
     * Set a tag on a brand or campaign
     *
     * @param  \TCR\Client\Model\Tag $body Tagging object (required)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\Tag, HTTP status code, HTTP response headers (array of strings)
     */
    public function setTagWithHttpInfo($body)
    {
        $returnType = '\TCR\Client\Model\Tag';
        $request = $this->setTagRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setTagAsync($body)
    {
        return $this->setTagAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation setTagAsyncWithHttpInfo
     *
     * Set a tag on a brand or campaign
     *
     * @param  \TCR\Client\Model\Tag $body Tagging object (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setTagAsyncWithHttpInfo($body)
    {
        $returnType = '\TCR\Client\Model\Tag';
        $request = $this->setTagRequest($body);
    ...
    /**
     * Create request for operation 'setTag'
     *
     * @param  \TCR\Client\Model\Tag $body Tagging object (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function setTagRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling setTag'
            );
        }
