...
class PlatformApi
{
     ...
     * @return \TCR\Client\Model\CspProfile
     */
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\CspProfile, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProfileWithHttpInfo()
    {
        $returnType = '\TCR\Client\Model\CspProfile';
