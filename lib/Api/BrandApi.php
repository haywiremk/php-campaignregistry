...
class BrandApi
{
     ...
     *
     * @param  \TCR\Client\Model\BrandRequest $body Brand to be created (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\Brand
     */
    public function createBrand($body)
    {
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\Brand, HTTP status code, HTTP response headers (array of strings)
     */
    public function createBrandWithHttpInfo($body)
    {
        $returnType = '\TCR\Client\Model\Brand';
     ...
     */
    public function createBrandAsync($body)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createBrandAsyncWithHttpInfo($body)
    {
        $returnType = '\TCR\Client\Model\Brand';
        $request = $this->createBrandRequest($body);
     ...
     */
    protected function createBrandRequest($body)
    {
    ...
    /**
     * Operation createBrandNonBlocking
     *
     ...
     * @return \TCR\Client\Model\Brand
     */
    public function createBrandNonBlocking($body)
    {
        list($response) = $this->createBrandNonBlockingWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation createBrandNonBlockingWithHttpInfo
     *
     * Create new Brand (Non-Blocking)
     *
     * @param  \TCR\Client\Model\BrandRequest $body Brand to be created (required)
     ...
     * @return array of \TCR\Client\Model\Brand, HTTP status code, HTTP response headers (array of strings)
     */
    public function createBrandNonBlockingWithHttpInfo($body)
    {
        $returnType = '\TCR\Client\Model\Brand';
        $request = $this->createBrandNonBlockingRequest($body);
    ...
    /**
     * Operation createBrandNonBlockingAsync
     *
     * Create new Brand (Non-Blocking)
     *
     * @param  \TCR\Client\Model\BrandRequest $body Brand to be created (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createBrandNonBlockingAsync($body)
    {
        return $this->createBrandNonBlockingAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createBrandNonBlockingAsyncWithHttpInfo
     *
     * Create new Brand (Non-Blocking)
     *
     * @param  \TCR\Client\Model\BrandRequest $body Brand to be created (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createBrandNonBlockingAsyncWithHttpInfo($body)
    {
        $returnType = '\TCR\Client\Model\Brand';
        $request = $this->createBrandNonBlockingRequest($body);
    ...
    /**
     * Create request for operation 'createBrandNonBlocking'
     *
     * @param  \TCR\Client\Model\BrandRequest $body Brand to be created (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createBrandNonBlockingRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createBrandNonBlocking'
            );
        }

        $resourcePath = '/brand/nonBlocking';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Delete brand
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    {
        $this->deleteBrandWithHttpInfo($brand_id);
    }
    ...
    {
        list($response) = $this->getBrandWithHttpInfo($brand_id);
        return $response;
    }
     ...
     */
    public function getBrandWithHttpInfo($brand_id)
    {
        $returnType = '\TCR\Client\Model\BrandCSP';
        $request = $this->getBrandRequest($brand_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBrandAsync($brand_id)
    {
        return $this->getBrandAsyncWithHttpInfo($brand_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBrandAsyncWithHttpInfo($brand_id)
    {
        $returnType = '\TCR\Client\Model\BrandCSP';
        $request = $this->getBrandRequest($brand_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getBrandRequest($brand_id)
    {
        // verify the required parameter 'brand_id' is set
        if ($brand_id === null || (is_array($brand_id) && count($brand_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\BrandFeedbackCSP
     */
    public function getBrandFeedback($brand_id)
    {
        list($response) = $this->getBrandFeedbackWithHttpInfo($brand_id);
        return $response;
    }

    /**
     * Operation getBrandFeedbackWithHttpInfo
     *
     * Get brand feedback by ID
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\BrandFeedbackCSP, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBrandFeedbackWithHttpInfo($brand_id)
    {
        $returnType = '\TCR\Client\Model\BrandFeedbackCSP';
        $request = $this->getBrandFeedbackRequest($brand_id);
    ...
    /**
     * Operation getBrandFeedbackAsync
     *
     * Get brand feedback by ID
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBrandFeedbackAsync($brand_id)
    {
        return $this->getBrandFeedbackAsyncWithHttpInfo($brand_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getBrandFeedbackAsyncWithHttpInfo
     *
     * Get brand feedback by ID
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBrandFeedbackAsyncWithHttpInfo($brand_id)
    {
        $returnType = '\TCR\Client\Model\BrandFeedbackCSP';
        $request = $this->getBrandFeedbackRequest($brand_id);
    ...
    /**
     * Create request for operation 'getBrandFeedback'
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getBrandFeedbackRequest($brand_id)
    {
        // verify the required parameter 'brand_id' is set
        if ($brand_id === null || (is_array($brand_id) && count($brand_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $brand_id when calling getBrandFeedback'
            );
        }

        $resourcePath = '/brand/feedback/{brandId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation importBrandExternalVetting
     *
     * Import external vetting record
     *
     * @param  \TCR\Client\Model\ExternalVettingImportRequest $body External vetting record to be imported for a given brand (required)
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\ExternalVetting
     */
    public function importBrandExternalVetting($body, $brand_id)
    {
        list($response) = $this->importBrandExternalVettingWithHttpInfo($body, $brand_id);
        return $response;
    }

    /**
     * Operation importBrandExternalVettingWithHttpInfo
     *
     * Import external vetting record
     *
     * @param  \TCR\Client\Model\ExternalVettingImportRequest $body External vetting record to be imported for a given brand (required)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\ExternalVetting, HTTP status code, HTTP response headers (array of strings)
     */
    public function importBrandExternalVettingWithHttpInfo($body, $brand_id)
    {
        $returnType = '\TCR\Client\Model\ExternalVetting';
        $request = $this->importBrandExternalVettingRequest($body, $brand_id);
    ...
    /**
     * Operation importBrandExternalVettingAsync
     *
     * Import external vetting record
     *
     * @param  \TCR\Client\Model\ExternalVettingImportRequest $body External vetting record to be imported for a given brand (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importBrandExternalVettingAsync($body, $brand_id)
    {
        return $this->importBrandExternalVettingAsyncWithHttpInfo($body, $brand_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation importBrandExternalVettingAsyncWithHttpInfo
     *
     * Import external vetting record
     *
     * @param  \TCR\Client\Model\ExternalVettingImportRequest $body External vetting record to be imported for a given brand (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importBrandExternalVettingAsyncWithHttpInfo($body, $brand_id)
    {
        $returnType = '\TCR\Client\Model\ExternalVetting';
        $request = $this->importBrandExternalVettingRequest($body, $brand_id);
    ...
    /**
     * Create request for operation 'importBrandExternalVetting'
     *
     * @param  \TCR\Client\Model\ExternalVettingImportRequest $body External vetting record to be imported for a given brand (required)
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function importBrandExternalVettingRequest($body, $brand_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling importBrandExternalVetting'
            );
        }
        // verify the required parameter 'brand_id' is set
        if ($brand_id === null || (is_array($brand_id) && count($brand_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $brand_id when calling importBrandExternalVetting'
            );
        }

        $resourcePath = '/brand/{brandId}/externalVetting';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $display_name DBA or trade name of the business. Partial spelling accepted. (optional)
     * @param  string $entity_type Brand entity type. (optional)
     * @param  string $identity_status Brand identity status. (optional)
     * @param  string $status Brand status. Default value is &#x27;ACTIVE&#x27; (optional, default to ACTIVE)
     * @param  string $state State or province. For U.S. input must conforms to 2-letter abbreviation. (optional)
     * @param  string $country ISO2 2-letter abbreveiation of country. (optional)
     * @param  string $ein Government assigned corporate tax ID. EIN is 9-digits in U.S. (optional)
     * @param  string $reseller_id Reseller ID. (optional)
     * @param  string[] $tag Tag (optional)
     * @param  bool $mock Mock brand Default &#x27;null&#x27; input returns both real and test brands. (optional)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\BrandRecordSetCSP
     */
    public function listBrands($reference_id = null, $display_name = null, $entity_type = null, $identity_status = null, $status = 'ACTIVE', $state = null, $country = null, $ein = null, $reseller_id = null, $tag = null, $mock = null, $page = '1', $records_per_page = '10')
    {
        list($response) = $this->listBrandsWithHttpInfo($reference_id, $display_name, $entity_type, $identity_status, $status, $state, $country, $ein, $reseller_id, $tag, $mock, $page, $records_per_page);
        return $response;
    }
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\BrandRecordSetCSP, HTTP status code, HTTP response headers (array of strings)
     */
    public function listBrandsWithHttpInfo($reference_id = null, $display_name = null, $entity_type = null, $identity_status = null, $status = 'ACTIVE', $state = null, $country = null, $ein = null, $reseller_id = null, $tag = null, $mock = null, $page = '1', $records_per_page = '10')
    {
        $returnType = '\TCR\Client\Model\BrandRecordSetCSP';
        $request = $this->listBrandsRequest($reference_id, $display_name, $entity_type, $identity_status, $status, $state, $country, $ein, $reseller_id, $tag, $mock, $page, $records_per_page);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listBrandsAsync($reference_id = null, $display_name = null, $entity_type = null, $identity_status = null, $status = 'ACTIVE', $state = null, $country = null, $ein = null, $reseller_id = null, $tag = null, $mock = null, $page = '1', $records_per_page = '10')
    {
        return $this->listBrandsAsyncWithHttpInfo($reference_id, $display_name, $entity_type, $identity_status, $status, $state, $country, $ein, $reseller_id, $tag, $mock, $page, $records_per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listBrandsAsyncWithHttpInfo($reference_id = null, $display_name = null, $entity_type = null, $identity_status = null, $status = 'ACTIVE', $state = null, $country = null, $ein = null, $reseller_id = null, $tag = null, $mock = null, $page = '1', $records_per_page = '10')
    {
        $returnType = '\TCR\Client\Model\BrandRecordSetCSP';
        $request = $this->listBrandsRequest($reference_id, $display_name, $entity_type, $identity_status, $status, $state, $country, $ein, $reseller_id, $tag, $mock, $page, $records_per_page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listBrandsRequest($reference_id = null, $display_name = null, $entity_type = null, $identity_status = null, $status = 'ACTIVE', $state = null, $country = null, $ein = null, $reseller_id = null, $tag = null, $mock = null, $page = '1', $records_per_page = '10')
    {
        ...
        if ($identity_status !== null) {
            $queryParams['identityStatus'] = ObjectSerializer::toQueryValue($identity_status, null);
        }
        // query params
        if ($status !== null) {
        ...
        // query params
        if ($ein !== null) {
            $queryParams['ein'] = ObjectSerializer::toQueryValue($ein, null);
        }
        // query params
        if ($reseller_id !== null) {
    ...
    /**
     * Operation listExternalVettings
     *
     * Get list of external vetting record for a given brand
     *
     * @param  string $brand_id Brand ID (required)
     * @param  string[] $vetting_status vetting_status (required)
     * @param  string $evp_id Vetting provider ID (optional)
     * @param  string $vetting_class Vetting class (optional)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\ExternalVetting[]
     */
    public function listExternalVettings($brand_id, $vetting_status, $evp_id = null, $vetting_class = null)
    {
        list($response) = $this->listExternalVettingsWithHttpInfo($brand_id, $vetting_status, $evp_id, $vetting_class);
        return $response;
    }

    /**
     * Operation listExternalVettingsWithHttpInfo
     *
     * Get list of external vetting record for a given brand
     *
     * @param  string $brand_id Brand ID (required)
     * @param  string[] $vetting_status (required)
     * @param  string $evp_id Vetting provider ID (optional)
     * @param  string $vetting_class Vetting class (optional)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     ...
     * @return array of \TCR\Client\Model\ExternalVetting[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listExternalVettingsWithHttpInfo($brand_id, $vetting_status, $evp_id = null, $vetting_class = null)
    {
        $returnType = '\TCR\Client\Model\ExternalVetting[]';
        $request = $this->listExternalVettingsRequest($brand_id, $vetting_status, $evp_id, $vetting_class);
    ...
    /**
     * Operation listExternalVettingsAsync
     *
     * Get list of external vetting record for a given brand
     *
     * @param  string $brand_id Brand ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listExternalVettingsAsync($brand_id, $vetting_status, $evp_id = null, $vetting_class = null)
    {
        return $this->listExternalVettingsAsyncWithHttpInfo($brand_id, $vetting_status, $evp_id, $vetting_class)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listExternalVettingsAsyncWithHttpInfo
     *
     * Get list of external vetting record for a given brand
     *
     * @param  string $brand_id Brand ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listExternalVettingsAsyncWithHttpInfo($brand_id, $vetting_status, $evp_id = null, $vetting_class = null)
    {
        $returnType = '\TCR\Client\Model\ExternalVetting[]';
        $request = $this->listExternalVettingsRequest($brand_id, $vetting_status, $evp_id, $vetting_class);
    ...
    /**
     * Create request for operation 'listExternalVettings'
     *
     * @param  string $brand_id Brand ID (required)
     * @param  string[] $vetting_status (required)
     * @param  string $evp_id Vetting provider ID (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listExternalVettingsRequest($brand_id, $vetting_status, $evp_id = null, $vetting_class = null)
    {
        // verify the required parameter 'brand_id' is set
        if ($brand_id === null || (is_array($brand_id) && count($brand_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $brand_id when calling listExternalVettings'
            );
        }
        // verify the required parameter 'vetting_status' is set
        if ($vetting_status === null || (is_array($vetting_status) && count($vetting_status) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $vetting_status when calling listExternalVettings'
            );
        }
        ...
        // query params
        if ($evp_id !== null) {
            $queryParams['evpId'] = ObjectSerializer::toQueryValue($evp_id, null);
        }
        // query params
        if ($vetting_class !== null) {
            $queryParams['vettingClass'] = ObjectSerializer::toQueryValue($vetting_class, null);
        }
        // query params
        if (is_array($vetting_status)) {
            $vetting_status = ObjectSerializer::serializeCollection($vetting_status, 'multi', true);
        }
        if ($vetting_status !== null) {
            $queryParams['vettingStatus'] = ObjectSerializer::toQueryValue($vetting_status, null);
        }
    ...
    /**
     * Operation orderBrandExternalVetting
     *
     * Order new external vetting for a brand
     *
     * @param  \TCR\Client\Model\ExternalVettingOrderRequest $body External vetting information to be updated (required)
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\ExternalVetting
     */
    public function orderBrandExternalVetting($body, $brand_id)
    {
        list($response) = $this->orderBrandExternalVettingWithHttpInfo($body, $brand_id);
        return $response;
    }

    /**
     * Operation orderBrandExternalVettingWithHttpInfo
     *
     * Order new external vetting for a brand
     *
     * @param  \TCR\Client\Model\ExternalVettingOrderRequest $body External vetting information to be updated (required)
     ...
     * @return array of \TCR\Client\Model\ExternalVetting, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderBrandExternalVettingWithHttpInfo($body, $brand_id)
    {
        $returnType = '\TCR\Client\Model\ExternalVetting';
        $request = $this->orderBrandExternalVettingRequest($body, $brand_id);
    ...
    /**
     * Operation orderBrandExternalVettingAsync
     *
     * Order new external vetting for a brand
     *
     * @param  \TCR\Client\Model\ExternalVettingOrderRequest $body External vetting information to be updated (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function orderBrandExternalVettingAsync($body, $brand_id)
    {
        return $this->orderBrandExternalVettingAsyncWithHttpInfo($body, $brand_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation orderBrandExternalVettingAsyncWithHttpInfo
     *
     * Order new external vetting for a brand
     *
     * @param  \TCR\Client\Model\ExternalVettingOrderRequest $body External vetting information to be updated (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function orderBrandExternalVettingAsyncWithHttpInfo($body, $brand_id)
    {
        $returnType = '\TCR\Client\Model\ExternalVetting';
        $request = $this->orderBrandExternalVettingRequest($body, $brand_id);
    ...
    /**
     * Create request for operation 'orderBrandExternalVetting'
     *
     * @param  \TCR\Client\Model\ExternalVettingOrderRequest $body External vetting information to be updated (required)
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function orderBrandExternalVettingRequest($body, $brand_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling orderBrandExternalVetting'
            );
        }
        // verify the required parameter 'brand_id' is set
        if ($brand_id === null || (is_array($brand_id) && count($brand_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $brand_id when calling orderBrandExternalVetting'
            );
        }
    ...
    /**
     * Operation revetBrand
     *
     * Revet the brand
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     * @param  bool $non_blocking non_blocking (optional, default to true)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\Brand
     */
    public function revetBrand($brand_id, $non_blocking = 'true')
    {
        list($response) = $this->revetBrandWithHttpInfo($brand_id, $non_blocking);
        return $response;
    }

    /**
     * Operation revetBrandWithHttpInfo
     *
     * Revet the brand
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     * @param  bool $non_blocking (optional, default to true)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\Brand, HTTP status code, HTTP response headers (array of strings)
     */
    public function revetBrandWithHttpInfo($brand_id, $non_blocking = 'true')
    {
        $returnType = '\TCR\Client\Model\Brand';
        $request = $this->revetBrandRequest($brand_id, $non_blocking);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function revetBrandAsync($brand_id, $non_blocking = 'true')
    {
        return $this->revetBrandAsyncWithHttpInfo($brand_id, $non_blocking)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation revetBrandAsyncWithHttpInfo
     *
     * Revet the brand
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function revetBrandAsyncWithHttpInfo($brand_id, $non_blocking = 'true')
    {
        $returnType = '\TCR\Client\Model\Brand';
        $request = $this->revetBrandRequest($brand_id, $non_blocking);
    ...
    /**
     * Create request for operation 'revetBrand'
     *
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     * @param  bool $non_blocking (optional, default to true)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function revetBrandRequest($brand_id, $non_blocking = 'true')
    {
        // verify the required parameter 'brand_id' is set
        if ($brand_id === null || (is_array($brand_id) && count($brand_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $brand_id when calling revetBrand'
            );
        }

        $resourcePath = '/brand/{brandId}/revet';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($non_blocking !== null) {
            $queryParams['nonBlocking'] = ObjectSerializer::toQueryValue($non_blocking, null);
        }
     ...
     *
     * @param  \TCR\Client\Model\UpdateBrand $body Brand properties to be updated (required)
     * @param  string $brand_id Brand alphanumeric identifier (prefixed with letter &#x27;B&#x27;) (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\Brand
     */
    public function updateBrand($body, $brand_id)
    {
        list($response) = $this->updateBrandWithHttpInfo($body, $brand_id);
        return $response;
    }
     ...
     * @return array of \TCR\Client\Model\Brand, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateBrandWithHttpInfo($body, $brand_id)
    {
        $returnType = '\TCR\Client\Model\Brand';
        $request = $this->updateBrandRequest($body, $brand_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBrandAsync($body, $brand_id)
    {
        return $this->updateBrandAsyncWithHttpInfo($body, $brand_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBrandAsyncWithHttpInfo($body, $brand_id)
    {
        $returnType = '\TCR\Client\Model\Brand';
        $request = $this->updateBrandRequest($body, $brand_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateBrandRequest($body, $brand_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
