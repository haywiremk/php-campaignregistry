...
/**
 * MockCVTokenApi Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
...
class MockCVTokenApi
{
     ...
     * @return string
     */
    public function createMockCvToken($brand_id, $locale = null, $valid_until = null)
    {
        list($response) = $this->createMockCvTokenWithHttpInfo($brand_id, $locale, $valid_until);
        return $response;
    }

    /**
     * Operation createMockCvTokenWithHttpInfo
     *
     * Generate mock CV token for Non-production environments
     *
     ...
     */
    public function createMockCvTokenWithHttpInfo($brand_id, $locale = null, $valid_until = null)
    {
        $returnType = 'string';
        $request = $this->createMockCvTokenRequest($brand_id, $locale, $valid_until);
    ...
    /**
     * Operation createMockCvTokenAsync
     *
     * Generate mock CV token for Non-production environments
     *
     * @param  string $brand_id (required)
     ...
     */
    public function createMockCvTokenAsync($brand_id, $locale = null, $valid_until = null)
    {
        return $this->createMockCvTokenAsyncWithHttpInfo($brand_id, $locale, $valid_until)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createMockCvTokenAsyncWithHttpInfo
     *
     * Generate mock CV token for Non-production environments
     *
     * @param  string $brand_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createMockCvTokenAsyncWithHttpInfo($brand_id, $locale = null, $valid_until = null)
    {
        $returnType = 'string';
        $request = $this->createMockCvTokenRequest($brand_id, $locale, $valid_until);
    ...
    /**
     * Create request for operation 'createMockCvToken'
     *
     * @param  string $brand_id (required)
     * @param  string $locale (optional)
     * @param  string $valid_until (optional)
     ...
     */
    protected function createMockCvTokenRequest($brand_id, $locale = null, $valid_until = null)
    {
        // verify the required parameter 'brand_id' is set
        if ($brand_id === null || (is_array($brand_id) && count($brand_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $brand_id when calling createMockCvToken'
            );
        }

        $resourcePath = '/brand/{brandId}/externalVetting/mockCvToken';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // form params
        if ($valid_until !== null) {
            $formParams['validUntil'] = ObjectSerializer::toFormValue($valid_until);
        }
        // body params
        $_tempBody = null;
