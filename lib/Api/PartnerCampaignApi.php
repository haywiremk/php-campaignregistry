...
/**
 * PartnerCampaignApi Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
...
class PartnerCampaignApi
{
    ...
    /**
     * Operation declineSharedPartnerCampaign
     *
     * Decline partner campaign sharing request
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     * @param  string $explanation Explanation for declining campaign. Maximum length 2000 chars. (optional)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\CampaignSharingStatus
     */
    public function declineSharedPartnerCampaign($campaign_id, $explanation = null)
    {
        list($response) = $this->declineSharedPartnerCampaignWithHttpInfo($campaign_id, $explanation);
        return $response;
    }

    /**
     * Operation declineSharedPartnerCampaignWithHttpInfo
     *
     * Decline partner campaign sharing request
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\CampaignSharingStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function declineSharedPartnerCampaignWithHttpInfo($campaign_id, $explanation = null)
    {
        $returnType = '\TCR\Client\Model\CampaignSharingStatus';
        $request = $this->declineSharedPartnerCampaignRequest($campaign_id, $explanation);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TCR\Client\Model\CampaignSharingStatus',
    ...
    /**
     * Operation declineSharedPartnerCampaignAsync
     *
     * Decline partner campaign sharing request
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     */
    public function declineSharedPartnerCampaignAsync($campaign_id, $explanation = null)
    {
        return $this->declineSharedPartnerCampaignAsyncWithHttpInfo($campaign_id, $explanation)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation declineSharedPartnerCampaignAsyncWithHttpInfo
     *
     * Decline partner campaign sharing request
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function declineSharedPartnerCampaignAsyncWithHttpInfo($campaign_id, $explanation = null)
    {
        $returnType = '\TCR\Client\Model\CampaignSharingStatus';
        $request = $this->declineSharedPartnerCampaignRequest($campaign_id, $explanation);
    ...
    /**
     * Create request for operation 'declineSharedPartnerCampaign'
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     * @param  string $explanation Explanation for declining campaign. Maximum length 2000 chars. (optional)
     *
     ...
     */
    protected function declineSharedPartnerCampaignRequest($campaign_id, $explanation = null)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling declineSharedPartnerCampaign'
            );
        }

        $resourcePath = '/partnerCampaign/{campaignId}/sharing';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($explanation !== null) {
            $queryParams['explanation'] = ObjectSerializer::toQueryValue($explanation, null);
        }
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\SharedCampaign
     */
    public function getPartnerCampaign($campaign_id)
    {
        list($response) = $this->getPartnerCampaignWithHttpInfo($campaign_id);
        return $response;
    }

    /**
     * Operation getPartnerCampaignWithHttpInfo
     *
     * Get partner shared campaign details
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\SharedCampaign, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPartnerCampaignWithHttpInfo($campaign_id)
    {
        $returnType = '\TCR\Client\Model\SharedCampaign';
        $request = $this->getPartnerCampaignRequest($campaign_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TCR\Client\Model\SharedCampaign',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getPartnerCampaignAsync
     *
     * Get partner shared campaign details
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerCampaignAsync($campaign_id)
    {
        return $this->getPartnerCampaignAsyncWithHttpInfo($campaign_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPartnerCampaignAsyncWithHttpInfo
     *
     * Get partner shared campaign details
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerCampaignAsyncWithHttpInfo($campaign_id)
    {
        $returnType = '\TCR\Client\Model\SharedCampaign';
        $request = $this->getPartnerCampaignRequest($campaign_id);
    ...
    /**
     * Create request for operation 'getPartnerCampaign'
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPartnerCampaignRequest($campaign_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling getPartnerCampaign'
            );
        }

        $resourcePath = '/partnerCampaign/{campaignId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getPartnerCampaignMnoMetadata
     *
     ...
     * @return object
     */
    public function getPartnerCampaignMnoMetadata($campaign_id)
    {
        list($response) = $this->getPartnerCampaignMnoMetadataWithHttpInfo($campaign_id);
        return $response;
    }

    /**
     * Operation getPartnerCampaignMnoMetadataWithHttpInfo
     *
     * Get partner campaign MNO metadata
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     */
    public function getPartnerCampaignMnoMetadataWithHttpInfo($campaign_id)
    {
        $returnType = 'object';
        $request = $this->getPartnerCampaignMnoMetadataRequest($campaign_id);
    ...
    /**
     * Operation getPartnerCampaignMnoMetadataAsync
     *
     * Get partner campaign MNO metadata
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerCampaignMnoMetadataAsync($campaign_id)
    {
        return $this->getPartnerCampaignMnoMetadataAsyncWithHttpInfo($campaign_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPartnerCampaignMnoMetadataAsyncWithHttpInfo
     *
     * Get partner campaign MNO metadata
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerCampaignMnoMetadataAsyncWithHttpInfo($campaign_id)
    {
        $returnType = 'object';
        $request = $this->getPartnerCampaignMnoMetadataRequest($campaign_id);
    ...
    /**
     * Create request for operation 'getPartnerCampaignMnoMetadata'
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPartnerCampaignMnoMetadataRequest($campaign_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling getPartnerCampaignMnoMetadata'
            );
        }

        $resourcePath = '/partnerCampaign/{campaignId}/mnoMetadata';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getPartnerCampaignOperationStatus
     *
     ...
     * @return object
     */
    public function getPartnerCampaignOperationStatus($campaign_id)
    {
        list($response) = $this->getPartnerCampaignOperationStatusWithHttpInfo($campaign_id);
        return $response;
    }

    /**
     * Operation getPartnerCampaignOperationStatusWithHttpInfo
     *
     * Get partner campaign operation status at MNO level
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPartnerCampaignOperationStatusWithHttpInfo($campaign_id)
    {
        $returnType = 'object';
        $request = $this->getPartnerCampaignOperationStatusRequest($campaign_id);
    ...
    /**
     * Operation getPartnerCampaignOperationStatusAsync
     *
     * Get partner campaign operation status at MNO level
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerCampaignOperationStatusAsync($campaign_id)
    {
        return $this->getPartnerCampaignOperationStatusAsyncWithHttpInfo($campaign_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPartnerCampaignOperationStatusAsyncWithHttpInfo
     *
     * Get partner campaign operation status at MNO level
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerCampaignOperationStatusAsyncWithHttpInfo($campaign_id)
    {
        $returnType = 'object';
        $request = $this->getPartnerCampaignOperationStatusRequest($campaign_id);
    ...
    /**
     * Create request for operation 'getPartnerCampaignOperationStatus'
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPartnerCampaignOperationStatusRequest($campaign_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling getPartnerCampaignOperationStatus'
            );
        }

        $resourcePath = '/partnerCampaign/{campaignId}/operationStatus';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getPartnerCampaignSharingStatus
     *
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\CampaignSharingChain
     */
    public function getPartnerCampaignSharingStatus($campaign_id)
    {
        list($response) = $this->getPartnerCampaignSharingStatusWithHttpInfo($campaign_id);
        return $response;
    }

    /**
     * Operation getPartnerCampaignSharingStatusWithHttpInfo
     *
     * Get partner campaign sharing status
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\CampaignSharingChain, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPartnerCampaignSharingStatusWithHttpInfo($campaign_id)
    {
        $returnType = '\TCR\Client\Model\CampaignSharingChain';
        $request = $this->getPartnerCampaignSharingStatusRequest($campaign_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TCR\Client\Model\CampaignSharingChain',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getPartnerCampaignSharingStatusAsync
     *
     * Get partner campaign sharing status
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerCampaignSharingStatusAsync($campaign_id)
    {
        return $this->getPartnerCampaignSharingStatusAsyncWithHttpInfo($campaign_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPartnerCampaignSharingStatusAsyncWithHttpInfo
     *
     * Get partner campaign sharing status
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerCampaignSharingStatusAsyncWithHttpInfo($campaign_id)
    {
        $returnType = '\TCR\Client\Model\CampaignSharingChain';
        $request = $this->getPartnerCampaignSharingStatusRequest($campaign_id);
    ...
    /**
     * Create request for operation 'getPartnerCampaignSharingStatus'
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPartnerCampaignSharingStatusRequest($campaign_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling getPartnerCampaignSharingStatus'
            );
        }
    ...
    /**
     * Operation getPartnerCampaignsByDownstreamCNP
     *
     * Search partner shared campaigns filtered by downstream connectivity partner
     *
     * @param  string $downstream_cnp_id Alphanumeric identifier of the downstream connectivity partner who shared campaign with you. (optional)
     * @param  string $brand_id Alphanumeric identifier of the Brand tied to the campaign. (optional)
     * @param  string[] $sharing_status Filter by sharing status (optional)
     * @param  string $start_date Shared date in yyyy-MM-dd format (optional)
     * @param  string $end_date Shared date in yyyy-MM-dd format (optional)
     * @param  int $page page (optional, default to 1)
     * @param  int $records_per_page Number of records per page. Max size is 500 (optional, default to 10)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\SharedCampaignRecordSet
     */
    public function getPartnerCampaignsByDownstreamCNP($downstream_cnp_id = null, $brand_id = null, $sharing_status = null, $start_date = null, $end_date = null, $page = '1', $records_per_page = '10')
    {
        list($response) = $this->getPartnerCampaignsByDownstreamCNPWithHttpInfo($downstream_cnp_id, $brand_id, $sharing_status, $start_date, $end_date, $page, $records_per_page);
        return $response;
    }

    /**
     * Operation getPartnerCampaignsByDownstreamCNPWithHttpInfo
     *
     * Search partner shared campaigns filtered by downstream connectivity partner
     *
     * @param  string $downstream_cnp_id Alphanumeric identifier of the downstream connectivity partner who shared campaign with you. (optional)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\SharedCampaignRecordSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPartnerCampaignsByDownstreamCNPWithHttpInfo($downstream_cnp_id = null, $brand_id = null, $sharing_status = null, $start_date = null, $end_date = null, $page = '1', $records_per_page = '10')
    {
        $returnType = '\TCR\Client\Model\SharedCampaignRecordSet';
        $request = $this->getPartnerCampaignsByDownstreamCNPRequest($downstream_cnp_id, $brand_id, $sharing_status, $start_date, $end_date, $page, $records_per_page);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TCR\Client\Model\SharedCampaignRecordSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getPartnerCampaignsByDownstreamCNPAsync
     *
     * Search partner shared campaigns filtered by downstream connectivity partner
     *
     * @param  string $downstream_cnp_id Alphanumeric identifier of the downstream connectivity partner who shared campaign with you. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerCampaignsByDownstreamCNPAsync($downstream_cnp_id = null, $brand_id = null, $sharing_status = null, $start_date = null, $end_date = null, $page = '1', $records_per_page = '10')
    {
        return $this->getPartnerCampaignsByDownstreamCNPAsyncWithHttpInfo($downstream_cnp_id, $brand_id, $sharing_status, $start_date, $end_date, $page, $records_per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPartnerCampaignsByDownstreamCNPAsyncWithHttpInfo
     *
     * Search partner shared campaigns filtered by downstream connectivity partner
     *
     * @param  string $downstream_cnp_id Alphanumeric identifier of the downstream connectivity partner who shared campaign with you. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerCampaignsByDownstreamCNPAsyncWithHttpInfo($downstream_cnp_id = null, $brand_id = null, $sharing_status = null, $start_date = null, $end_date = null, $page = '1', $records_per_page = '10')
    {
        $returnType = '\TCR\Client\Model\SharedCampaignRecordSet';
        $request = $this->getPartnerCampaignsByDownstreamCNPRequest($downstream_cnp_id, $brand_id, $sharing_status, $start_date, $end_date, $page, $records_per_page);
    ...
    /**
     * Create request for operation 'getPartnerCampaignsByDownstreamCNP'
     *
     * @param  string $downstream_cnp_id Alphanumeric identifier of the downstream connectivity partner who shared campaign with you. (optional)
     * @param  string $brand_id Alphanumeric identifier of the Brand tied to the campaign. (optional)
     * @param  string[] $sharing_status Filter by sharing status (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPartnerCampaignsByDownstreamCNPRequest($downstream_cnp_id = null, $brand_id = null, $sharing_status = null, $start_date = null, $end_date = null, $page = '1', $records_per_page = '10')
    {

        $resourcePath = '/partnerCampaign/sharedWithMe';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($downstream_cnp_id !== null) {
            $queryParams['downstreamCnpId'] = ObjectSerializer::toQueryValue($downstream_cnp_id, null);
        }
        // query params
        if ($brand_id !== null) {
        ...
        // query params
        if (is_array($sharing_status)) {
            $sharing_status = ObjectSerializer::serializeCollection($sharing_status, 'multi', true);
        }
        if ($sharing_status !== null) {
            $queryParams['sharingStatus'] = ObjectSerializer::toQueryValue($sharing_status, null);
        }
        // query params
        if ($start_date !== null) {
    ...
    /**
     * Operation getPartnerCampaignsByUpstreamCNP
     *
     * Search partner shared campaigns filtered by upstream connectivity partner
     *
     * @param  string $upstream_cnp_id Alphanumeric identifier of your upstream connectivity partner. (optional)
     * @param  string $brand_id Alphanumeric identifier of the Brand tied to the campaign. (optional)
     * @param  string[] $sharing_status Filter by sharing status (optional)
     * @param  string $start_date Shared date in yyyy-MM-dd format (optional)
     * @param  string $end_date Shared date in yyyy-MM-dd format (optional)
     ...
     * @return \TCR\Client\Model\SharedCampaignRecordSet
     */
    public function getPartnerCampaignsByUpstreamCNP($upstream_cnp_id = null, $brand_id = null, $sharing_status = null, $start_date = null, $end_date = null, $page = '1', $records_per_page = '10')
    {
        list($response) = $this->getPartnerCampaignsByUpstreamCNPWithHttpInfo($upstream_cnp_id, $brand_id, $sharing_status, $start_date, $end_date, $page, $records_per_page);
        return $response;
    }

    /**
     * Operation getPartnerCampaignsByUpstreamCNPWithHttpInfo
     *
     * Search partner shared campaigns filtered by upstream connectivity partner
     *
     * @param  string $upstream_cnp_id Alphanumeric identifier of your upstream connectivity partner. (optional)
     ...
     * @return array of \TCR\Client\Model\SharedCampaignRecordSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPartnerCampaignsByUpstreamCNPWithHttpInfo($upstream_cnp_id = null, $brand_id = null, $sharing_status = null, $start_date = null, $end_date = null, $page = '1', $records_per_page = '10')
    {
        $returnType = '\TCR\Client\Model\SharedCampaignRecordSet';
        $request = $this->getPartnerCampaignsByUpstreamCNPRequest($upstream_cnp_id, $brand_id, $sharing_status, $start_date, $end_date, $page, $records_per_page);
    ...
    /**
     * Operation getPartnerCampaignsByUpstreamCNPAsync
     *
     * Search partner shared campaigns filtered by upstream connectivity partner
     *
     * @param  string $upstream_cnp_id Alphanumeric identifier of your upstream connectivity partner. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerCampaignsByUpstreamCNPAsync($upstream_cnp_id = null, $brand_id = null, $sharing_status = null, $start_date = null, $end_date = null, $page = '1', $records_per_page = '10')
    {
        return $this->getPartnerCampaignsByUpstreamCNPAsyncWithHttpInfo($upstream_cnp_id, $brand_id, $sharing_status, $start_date, $end_date, $page, $records_per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPartnerCampaignsByUpstreamCNPAsyncWithHttpInfo
     *
     * Search partner shared campaigns filtered by upstream connectivity partner
     *
     * @param  string $upstream_cnp_id Alphanumeric identifier of your upstream connectivity partner. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPartnerCampaignsByUpstreamCNPAsyncWithHttpInfo($upstream_cnp_id = null, $brand_id = null, $sharing_status = null, $start_date = null, $end_date = null, $page = '1', $records_per_page = '10')
    {
        $returnType = '\TCR\Client\Model\SharedCampaignRecordSet';
        $request = $this->getPartnerCampaignsByUpstreamCNPRequest($upstream_cnp_id, $brand_id, $sharing_status, $start_date, $end_date, $page, $records_per_page);
    ...
    /**
     * Create request for operation 'getPartnerCampaignsByUpstreamCNP'
     *
     * @param  string $upstream_cnp_id Alphanumeric identifier of your upstream connectivity partner. (optional)
     * @param  string $brand_id Alphanumeric identifier of the Brand tied to the campaign. (optional)
     * @param  string[] $sharing_status Filter by sharing status (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPartnerCampaignsByUpstreamCNPRequest($upstream_cnp_id = null, $brand_id = null, $sharing_status = null, $start_date = null, $end_date = null, $page = '1', $records_per_page = '10')
    {

        $resourcePath = '/partnerCampaign/sharedByMe';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($upstream_cnp_id !== null) {
            $queryParams['upstreamCnpId'] = ObjectSerializer::toQueryValue($upstream_cnp_id, null);
        }
        // query params
        if ($brand_id !== null) {
            $queryParams['brandId'] = ObjectSerializer::toQueryValue($brand_id, null);
    ...
    /**
     * Operation sharePartnerCampaign
     *
     * Share partner campaign with an upstream connectivity partner
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     * @param  string $upstream_cnp_id Alphanumeric identifier of your upstream connectivity partner. (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\CampaignSharingStatus
     */
    public function sharePartnerCampaign($campaign_id, $upstream_cnp_id)
    {
        list($response) = $this->sharePartnerCampaignWithHttpInfo($campaign_id, $upstream_cnp_id);
        return $response;
    }

    /**
     * Operation sharePartnerCampaignWithHttpInfo
     *
     * Share partner campaign with an upstream connectivity partner
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return array of \TCR\Client\Model\CampaignSharingStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function sharePartnerCampaignWithHttpInfo($campaign_id, $upstream_cnp_id)
    {
        $returnType = '\TCR\Client\Model\CampaignSharingStatus';
        $request = $this->sharePartnerCampaignRequest($campaign_id, $upstream_cnp_id);
    ...
    /**
     * Operation sharePartnerCampaignAsync
     *
     * Share partner campaign with an upstream connectivity partner
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sharePartnerCampaignAsync($campaign_id, $upstream_cnp_id)
    {
        return $this->sharePartnerCampaignAsyncWithHttpInfo($campaign_id, $upstream_cnp_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation sharePartnerCampaignAsyncWithHttpInfo
     *
     * Share partner campaign with an upstream connectivity partner
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sharePartnerCampaignAsyncWithHttpInfo($campaign_id, $upstream_cnp_id)
    {
        $returnType = '\TCR\Client\Model\CampaignSharingStatus';
        $request = $this->sharePartnerCampaignRequest($campaign_id, $upstream_cnp_id);
    ...
    /**
     * Create request for operation 'sharePartnerCampaign'
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     * @param  string $upstream_cnp_id Alphanumeric identifier of your upstream connectivity partner. (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sharePartnerCampaignRequest($campaign_id, $upstream_cnp_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling sharePartnerCampaign'
            );
        }
        // verify the required parameter 'upstream_cnp_id' is set
        if ($upstream_cnp_id === null || (is_array($upstream_cnp_id) && count($upstream_cnp_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $upstream_cnp_id when calling sharePartnerCampaign'
            );
        }

        $resourcePath = '/partnerCampaign/{campaignId}/sharing/{upstreamCnpId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($upstream_cnp_id !== null) {
            $resourcePath = str_replace(
                '{' . 'upstreamCnpId' . '}',
                ObjectSerializer::toPathValue($upstream_cnp_id),
                $resourcePath
            );
        }
