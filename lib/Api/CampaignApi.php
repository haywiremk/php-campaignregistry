...
class CampaignApi
{
    ...
    /**
     * Operation deactivateMyCampaign
     *
     ...
     * @return void
     */
    public function deactivateMyCampaign($campaign_id)
    {
        $this->deactivateMyCampaignWithHttpInfo($campaign_id);
    }

    /**
     * Operation deactivateMyCampaignWithHttpInfo
     *
     * Deactivate my campaign
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     */
    public function deactivateMyCampaignWithHttpInfo($campaign_id)
    {
        $returnType = '';
        $request = $this->deactivateMyCampaignRequest($campaign_id);
    ...
    /**
     * Operation deactivateMyCampaignAsync
     *
     * Deactivate my campaign
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     */
    public function deactivateMyCampaignAsync($campaign_id)
    {
        return $this->deactivateMyCampaignAsyncWithHttpInfo($campaign_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deactivateMyCampaignAsyncWithHttpInfo
     *
     * Deactivate my campaign
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deactivateMyCampaignAsyncWithHttpInfo($campaign_id)
    {
        $returnType = '';
        $request = $this->deactivateMyCampaignRequest($campaign_id);
    ...
    /**
     * Create request for operation 'deactivateMyCampaign'
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function deactivateMyCampaignRequest($campaign_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling deactivateMyCampaign'
            );
        }
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\CampaignCSP
     */
    public function getMyCampaign($campaign_id)
    {
        list($response) = $this->getMyCampaignWithHttpInfo($campaign_id);
        return $response;
    }

    /**
     * Operation getMyCampaignWithHttpInfo
     *
     * Get my campaign details
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\CampaignCSP, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMyCampaignWithHttpInfo($campaign_id)
    {
        $returnType = '\TCR\Client\Model\CampaignCSP';
        $request = $this->getMyCampaignRequest($campaign_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyCampaignAsync($campaign_id)
    {
        return $this->getMyCampaignAsyncWithHttpInfo($campaign_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getMyCampaignAsyncWithHttpInfo
     *
     * Get my campaign details
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyCampaignAsyncWithHttpInfo($campaign_id)
    {
        $returnType = '\TCR\Client\Model\CampaignCSP';
        $request = $this->getMyCampaignRequest($campaign_id);
    ...
    /**
     * Create request for operation 'getMyCampaign'
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMyCampaignRequest($campaign_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling getMyCampaign'
            );
        }
    ...
    /**
     * Operation getMyCampaignMnoMetadata
     *
     ...
     * @return object
     */
    public function getMyCampaignMnoMetadata($campaign_id)
    {
        list($response) = $this->getMyCampaignMnoMetadataWithHttpInfo($campaign_id);
        return $response;
    }

    /**
     * Operation getMyCampaignMnoMetadataWithHttpInfo
     *
     * Get my campaign MNO metadata
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     */
    public function getMyCampaignMnoMetadataWithHttpInfo($campaign_id)
    {
        $returnType = 'object';
        $request = $this->getMyCampaignMnoMetadataRequest($campaign_id);
    ...
    /**
     * Operation getMyCampaignMnoMetadataAsync
     *
     * Get my campaign MNO metadata
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyCampaignMnoMetadataAsync($campaign_id)
    {
        return $this->getMyCampaignMnoMetadataAsyncWithHttpInfo($campaign_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getMyCampaignMnoMetadataAsyncWithHttpInfo
     *
     * Get my campaign MNO metadata
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyCampaignMnoMetadataAsyncWithHttpInfo($campaign_id)
    {
        $returnType = 'object';
        $request = $this->getMyCampaignMnoMetadataRequest($campaign_id);
    ...
    /**
     * Create request for operation 'getMyCampaignMnoMetadata'
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMyCampaignMnoMetadataRequest($campaign_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling getMyCampaignMnoMetadata'
            );
        }

        $resourcePath = '/campaign/{campaignId}/mnoMetadata';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getMyCampaignOperationStatus
     *
     ...
     * @return object
     */
    public function getMyCampaignOperationStatus($campaign_id)
    {
        list($response) = $this->getMyCampaignOperationStatusWithHttpInfo($campaign_id);
        return $response;
    }

    /**
     * Operation getMyCampaignOperationStatusWithHttpInfo
     *
     * Get campaign operation status at MNO level
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMyCampaignOperationStatusWithHttpInfo($campaign_id)
    {
        $returnType = 'object';
        $request = $this->getMyCampaignOperationStatusRequest($campaign_id);
    ...
    /**
     * Operation getMyCampaignOperationStatusAsync
     *
     * Get campaign operation status at MNO level
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyCampaignOperationStatusAsync($campaign_id)
    {
        return $this->getMyCampaignOperationStatusAsyncWithHttpInfo($campaign_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getMyCampaignOperationStatusAsyncWithHttpInfo
     *
     * Get campaign operation status at MNO level
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyCampaignOperationStatusAsyncWithHttpInfo($campaign_id)
    {
        $returnType = 'object';
        $request = $this->getMyCampaignOperationStatusRequest($campaign_id);
    ...
    /**
     * Create request for operation 'getMyCampaignOperationStatus'
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMyCampaignOperationStatusRequest($campaign_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling getMyCampaignOperationStatus'
            );
        }

        $resourcePath = '/campaign/{campaignId}/operationStatus';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getMyCampaignSharingStatus
     *
     ...
     */
    public function getMyCampaignSharingStatus($campaign_id)
    {
        list($response) = $this->getMyCampaignSharingStatusWithHttpInfo($campaign_id);
        return $response;
    }

    /**
     * Operation getMyCampaignSharingStatusWithHttpInfo
     *
     * Get my campaign sharing status
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     */
    public function getMyCampaignSharingStatusWithHttpInfo($campaign_id)
    {
        $returnType = '\TCR\Client\Model\CampaignSharingChain';
        $request = $this->getMyCampaignSharingStatusRequest($campaign_id);
    ...
    /**
     * Operation getMyCampaignSharingStatusAsync
     *
     * Get my campaign sharing status
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyCampaignSharingStatusAsync($campaign_id)
    {
        return $this->getMyCampaignSharingStatusAsyncWithHttpInfo($campaign_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getMyCampaignSharingStatusAsyncWithHttpInfo
     *
     * Get my campaign sharing status
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyCampaignSharingStatusAsyncWithHttpInfo($campaign_id)
    {
        $returnType = '\TCR\Client\Model\CampaignSharingChain';
        $request = $this->getMyCampaignSharingStatusRequest($campaign_id);
    ...
    /**
     * Create request for operation 'getMyCampaignSharingStatus'
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMyCampaignSharingStatusRequest($campaign_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling getMyCampaignSharingStatus'
            );
        }

        $resourcePath = '/campaign/{campaignId}/sharing';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getMyOsrCampaignAttributes
     *
     ...
     * @return object
     */
    public function getMyOsrCampaignAttributes($campaign_id)
    {
        list($response) = $this->getMyOsrCampaignAttributesWithHttpInfo($campaign_id);
        return $response;
    }

    /**
     * Operation getMyOsrCampaignAttributesWithHttpInfo
     *
     * Get my campaign attributes from OSR
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMyOsrCampaignAttributesWithHttpInfo($campaign_id)
    {
        $returnType = 'object';
        $request = $this->getMyOsrCampaignAttributesRequest($campaign_id);
    ...
    /**
     * Operation getMyOsrCampaignAttributesAsync
     *
     * Get my campaign attributes from OSR
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyOsrCampaignAttributesAsync($campaign_id)
    {
        return $this->getMyOsrCampaignAttributesAsyncWithHttpInfo($campaign_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getMyOsrCampaignAttributesAsyncWithHttpInfo
     *
     * Get my campaign attributes from OSR
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMyOsrCampaignAttributesAsyncWithHttpInfo($campaign_id)
    {
        $returnType = 'object';
        $request = $this->getMyOsrCampaignAttributesRequest($campaign_id);
    ...
    /**
     * Create request for operation 'getMyOsrCampaignAttributes'
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMyOsrCampaignAttributesRequest($campaign_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling getMyOsrCampaignAttributes'
            );
        }

        $resourcePath = '/campaign/{campaignId}/osr/attributes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation listMyCampaigns
     *
     * Search my campaigns
     *
     * @param  string $reference_id Reference ID. (optional)
     * @param  string $brand_id Must be an exact match if present (optional)
     * @param  string $status status (optional)
     * @param  string $usecase Must be an exact match if present (optional)
     * @param  string $vertical Must be an exact match if present (optional)
     * @param  string $reseller_id Must be an exact match if present (optional)
     * @param  bool $auto_renewal Campaign auto-renewal status (optional)
     * @param  string $upstream_cnp_id Upstream CNP whom you shared campaign (optional)
     * @param  string[] $tag Tag (optional)
     * @param  bool $mock Mock brand Default &#x27;null&#x27; input returns both real and test campaigns. (optional)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\CampaignRecordSetCSP
     */
    public function listMyCampaigns($reference_id = null, $brand_id = null, $status = null, $usecase = null, $vertical = null, $reseller_id = null, $auto_renewal = null, $upstream_cnp_id = null, $tag = null, $mock = null, $page = '1', $records_per_page = '10')
    {
        list($response) = $this->listMyCampaignsWithHttpInfo($reference_id, $brand_id, $status, $usecase, $vertical, $reseller_id, $auto_renewal, $upstream_cnp_id, $tag, $mock, $page, $records_per_page);
        return $response;
    }

    /**
     * Operation listMyCampaignsWithHttpInfo
     *
     * Search my campaigns
     *
     * @param  string $reference_id Reference ID. (optional)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\CampaignRecordSetCSP, HTTP status code, HTTP response headers (array of strings)
     */
    public function listMyCampaignsWithHttpInfo($reference_id = null, $brand_id = null, $status = null, $usecase = null, $vertical = null, $reseller_id = null, $auto_renewal = null, $upstream_cnp_id = null, $tag = null, $mock = null, $page = '1', $records_per_page = '10')
    {
        $returnType = '\TCR\Client\Model\CampaignRecordSetCSP';
        $request = $this->listMyCampaignsRequest($reference_id, $brand_id, $status, $usecase, $vertical, $reseller_id, $auto_renewal, $upstream_cnp_id, $tag, $mock, $page, $records_per_page);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TCR\Client\Model\CampaignRecordSetCSP',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation listMyCampaignsAsync
     *
     * Search my campaigns
     *
     * @param  string $reference_id Reference ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listMyCampaignsAsync($reference_id = null, $brand_id = null, $status = null, $usecase = null, $vertical = null, $reseller_id = null, $auto_renewal = null, $upstream_cnp_id = null, $tag = null, $mock = null, $page = '1', $records_per_page = '10')
    {
        return $this->listMyCampaignsAsyncWithHttpInfo($reference_id, $brand_id, $status, $usecase, $vertical, $reseller_id, $auto_renewal, $upstream_cnp_id, $tag, $mock, $page, $records_per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listMyCampaignsAsyncWithHttpInfo
     *
     * Search my campaigns
     *
     * @param  string $reference_id Reference ID. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listMyCampaignsAsyncWithHttpInfo($reference_id = null, $brand_id = null, $status = null, $usecase = null, $vertical = null, $reseller_id = null, $auto_renewal = null, $upstream_cnp_id = null, $tag = null, $mock = null, $page = '1', $records_per_page = '10')
    {
        $returnType = '\TCR\Client\Model\CampaignRecordSetCSP';
        $request = $this->listMyCampaignsRequest($reference_id, $brand_id, $status, $usecase, $vertical, $reseller_id, $auto_renewal, $upstream_cnp_id, $tag, $mock, $page, $records_per_page);
    ...
    /**
     * Create request for operation 'listMyCampaigns'
     *
     * @param  string $reference_id Reference ID. (optional)
     * @param  string $brand_id Must be an exact match if present (optional)
     * @param  string $status (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listMyCampaignsRequest($reference_id = null, $brand_id = null, $status = null, $usecase = null, $vertical = null, $reseller_id = null, $auto_renewal = null, $upstream_cnp_id = null, $tag = null, $mock = null, $page = '1', $records_per_page = '10')
    {
        ...
        if ($reference_id !== null) {
            $queryParams['referenceId'] = ObjectSerializer::toQueryValue($reference_id, null);
        }
        // query params
        if ($brand_id !== null) {
        ...
        // query params
        if ($usecase !== null) {
            $queryParams['usecase'] = ObjectSerializer::toQueryValue($usecase, null);
        }
        // query params
        if ($vertical !== null) {
            $queryParams['vertical'] = ObjectSerializer::toQueryValue($vertical, null);
        }
        // query params
        if ($reseller_id !== null) {
            $queryParams['resellerId'] = ObjectSerializer::toQueryValue($reseller_id, null);
        }
        // query params
        if ($auto_renewal !== null) {
            $queryParams['autoRenewal'] = ObjectSerializer::toQueryValue($auto_renewal, null);
        }
        // query params
        ...
        // query params
        if ($mock !== null) {
            $queryParams['mock'] = ObjectSerializer::toQueryValue($mock, null);
        }
        // query params
        if ($page !== null) {
     ...
     */
    public function shareMyCampaign($campaign_id, $upstream_cnp_id)
    {
        list($response) = $this->shareMyCampaignWithHttpInfo($campaign_id, $upstream_cnp_id);
        return $response;
    }

    /**
     * Operation shareMyCampaignWithHttpInfo
     *
     * Share my campaign to an upstream connectivity partner. ** Replaces elect primary DCA for campaign **
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     */
    public function shareMyCampaignWithHttpInfo($campaign_id, $upstream_cnp_id)
    {
        $returnType = '\TCR\Client\Model\CampaignSharingStatus';
        $request = $this->shareMyCampaignRequest($campaign_id, $upstream_cnp_id);
    ...
    /**
     * Operation shareMyCampaignAsync
     *
     * Share my campaign to an upstream connectivity partner. ** Replaces elect primary DCA for campaign **
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shareMyCampaignAsync($campaign_id, $upstream_cnp_id)
    {
        return $this->shareMyCampaignAsyncWithHttpInfo($campaign_id, $upstream_cnp_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation shareMyCampaignAsyncWithHttpInfo
     *
     * Share my campaign to an upstream connectivity partner. ** Replaces elect primary DCA for campaign **
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shareMyCampaignAsyncWithHttpInfo($campaign_id, $upstream_cnp_id)
    {
        $returnType = '\TCR\Client\Model\CampaignSharingStatus';
        $request = $this->shareMyCampaignRequest($campaign_id, $upstream_cnp_id);
    ...
    /**
     * Create request for operation 'shareMyCampaign'
     *
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     * @param  string $upstream_cnp_id Alphanumeric identifier of your upstream connectivity partner. (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function shareMyCampaignRequest($campaign_id, $upstream_cnp_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling shareMyCampaign'
            );
        }
        ...
        if ($upstream_cnp_id === null || (is_array($upstream_cnp_id) && count($upstream_cnp_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $upstream_cnp_id when calling shareMyCampaign'
            );
        }

        $resourcePath = '/campaign/{campaignId}/sharing/{upstreamCnpId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation updateMyCampaign
     *
     * Update my campaign properties
     *
     * @param  \TCR\Client\Model\UpdateCampaign $body Campaign properties to be updated.  Only subset of campaign properties can be updated. (required)
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\Campaign
     */
    public function updateMyCampaign($body, $campaign_id)
    {
        list($response) = $this->updateMyCampaignWithHttpInfo($body, $campaign_id);
        return $response;
    }

    /**
     * Operation updateMyCampaignWithHttpInfo
     *
     * Update my campaign properties
     *
     * @param  \TCR\Client\Model\UpdateCampaign $body Campaign properties to be updated.  Only subset of campaign properties can be updated. (required)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\Campaign, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateMyCampaignWithHttpInfo($body, $campaign_id)
    {
        $returnType = '\TCR\Client\Model\Campaign';
        $request = $this->updateMyCampaignRequest($body, $campaign_id);
    ...
    /**
     * Operation updateMyCampaignAsync
     *
     * Update my campaign properties
     *
     * @param  \TCR\Client\Model\UpdateCampaign $body Campaign properties to be updated.  Only subset of campaign properties can be updated. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMyCampaignAsync($body, $campaign_id)
    {
        return $this->updateMyCampaignAsyncWithHttpInfo($body, $campaign_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateMyCampaignAsyncWithHttpInfo
     *
     * Update my campaign properties
     *
     * @param  \TCR\Client\Model\UpdateCampaign $body Campaign properties to be updated.  Only subset of campaign properties can be updated. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMyCampaignAsyncWithHttpInfo($body, $campaign_id)
    {
        $returnType = '\TCR\Client\Model\Campaign';
        $request = $this->updateMyCampaignRequest($body, $campaign_id);
    ...
    /**
     * Create request for operation 'updateMyCampaign'
     *
     * @param  \TCR\Client\Model\UpdateCampaign $body Campaign properties to be updated.  Only subset of campaign properties can be updated. (required)
     * @param  string $campaign_id Campaign alphanumeric identifier (prefixed with letter &#x27;C&#x27;) (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateMyCampaignRequest($body, $campaign_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateMyCampaign'
            );
        }
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaign_id when calling updateMyCampaign'
            );
        }
