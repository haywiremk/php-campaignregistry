...
class WebhookApi
{
    ...
    {
        list($response) = $this->listEventCategoriesWithHttpInfo();
        return $response;
    }

    /**
     * Operation listEventCategoriesWithHttpInfo
     *
     * List all event categories
     *
     *
     ...
     */
    public function listEventCategoriesWithHttpInfo()
    {
        $returnType = 'string[]';
        $request = $this->listEventCategoriesRequest();
    ...
    /**
     * Operation listEventCategoriesAsync
     *
     * List all event categories
     *
     *
     ...
     */
    public function listEventCategoriesAsync()
    {
        return $this->listEventCategoriesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listEventCategoriesAsyncWithHttpInfo
     *
     * List all event categories
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listEventCategoriesAsyncWithHttpInfo()
    {
        $returnType = 'string[]';
        $request = $this->listEventCategoriesRequest();
    ...
    /**
     * Create request for operation 'listEventCategories'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listEventCategoriesRequest()
    {

        $resourcePath = '/webhook/eventCategory';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\EventType[]
     */
    public function listEventTypes()
    {
        list($response) = $this->listEventTypesWithHttpInfo();
        return $response;
    }
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\EventType[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listEventTypesWithHttpInfo()
    {
        $returnType = '\TCR\Client\Model\EventType[]';
        $request = $this->listEventTypesRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listEventTypesAsync()
    {
        return $this->listEventTypesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listEventTypesAsyncWithHttpInfo()
    {
        $returnType = '\TCR\Client\Model\EventType[]';
        $request = $this->listEventTypesRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listEventTypesRequest()
    {

        $resourcePath = '/webhook/eventType';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\WebhookSubscription[]
     */
    public function listWebhook()
    {
        list($response) = $this->listWebhookWithHttpInfo();
        return $response;
    }

    /**
     * Operation listWebhookWithHttpInfo
     *
     * List all webhook subscriptions
     *
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\WebhookSubscription[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listWebhookWithHttpInfo()
    {
        $returnType = '\TCR\Client\Model\WebhookSubscription[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TCR\Client\Model\WebhookSubscription[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listWebhookAsync()
    {
        return $this->listWebhookAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listWebhookAsyncWithHttpInfo
     *
     * List all webhook subscriptions
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listWebhookAsyncWithHttpInfo()
    {
        $returnType = '\TCR\Client\Model\WebhookSubscription[]';
        $request = $this->listWebhookRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listWebhookRequest()
    {

        $resourcePath = '/webhook/subscription';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \TCR\Client\Model\WebhookSubscription $body WebhookSubscription schema to subscribe event notification (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\WebhookSubscription
     */
    public function subscribeWebhook($body)
    {
        list($response) = $this->subscribeWebhookWithHttpInfo($body);
        return $response;
    }
     ...
     * @return array of \TCR\Client\Model\WebhookSubscription, HTTP status code, HTTP response headers (array of strings)
     */
    public function subscribeWebhookWithHttpInfo($body)
    {
        $returnType = '\TCR\Client\Model\WebhookSubscription';
        $request = $this->subscribeWebhookRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subscribeWebhookAsync($body)
    {
        return $this->subscribeWebhookAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subscribeWebhookAsyncWithHttpInfo($body)
    {
        $returnType = '\TCR\Client\Model\WebhookSubscription';
        $request = $this->subscribeWebhookRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function subscribeWebhookRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling subscribeWebhook'
            );
        }
     ...
     *
     * @param  string $event_category event_category (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function testWebhook($event_category)
    {
        list($response) = $this->testWebhookWithHttpInfo($event_category);
        return $response;
    }
     ...
     * Test webhook by event (Deprecated)
     *
     * @param  string $event_category (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function testWebhookWithHttpInfo($event_category)
    {
        $returnType = 'object';
        $request = $this->testWebhookRequest($event_category);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testWebhookAsync($event_category)
    {
        return $this->testWebhookAsyncWithHttpInfo($event_category)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testWebhookAsyncWithHttpInfo($event_category)
    {
        $returnType = 'object';
        $request = $this->testWebhookRequest($event_category);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function testWebhookRequest($event_category)
    {
        // verify the required parameter 'event_category' is set
        if ($event_category === null || (is_array($event_category) && count($event_category) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $event_category when calling testWebhook'
            );
        }

        $resourcePath = '/webhook/subscription/{eventCategory}/test';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($event_category !== null) {
            $resourcePath = str_replace(
                '{' . 'eventCategory' . '}',
                ObjectSerializer::toPathValue($event_category),
                $resourcePath
            );
        }
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\WebhookResponse
     */
    public function testWebhook1($event_type)
    {
        list($response) = $this->testWebhook1WithHttpInfo($event_type);
        return $response;
    }

    /**
     * Operation testWebhook1WithHttpInfo
     *
     * Send a mock webhook to your endpoint
     *
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\WebhookResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function testWebhook1WithHttpInfo($event_type)
    {
        $returnType = '\TCR\Client\Model\WebhookResponse';
        $request = $this->testWebhook1Request($event_type);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TCR\Client\Model\WebhookResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testWebhook1Async($event_type)
    {
        return $this->testWebhook1AsyncWithHttpInfo($event_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation testWebhook1AsyncWithHttpInfo
     *
     * Send a mock webhook to your endpoint
     *
     * @param  string $event_type (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testWebhook1AsyncWithHttpInfo($event_type)
    {
        $returnType = '\TCR\Client\Model\WebhookResponse';
        $request = $this->testWebhook1Request($event_type);
    ...
    /**
     * Create request for operation 'testWebhook1'
     *
     * @param  string $event_type (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function testWebhook1Request($event_type)
    {
        // verify the required parameter 'event_type' is set
        if ($event_type === null || (is_array($event_type) && count($event_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $event_type when calling testWebhook1'
            );
        }

        $resourcePath = '/webhook/subscription/eventType/{eventType}/mock';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return void
     */
    public function unsubscribeWebhook($event_category)
    {
        $this->unsubscribeWebhookWithHttpInfo($event_category);
    }
     ...
     */
    public function unsubscribeWebhookWithHttpInfo($event_category)
    {
        $returnType = '';
        $request = $this->unsubscribeWebhookRequest($event_category);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unsubscribeWebhookAsync($event_category)
    {
        return $this->unsubscribeWebhookAsyncWithHttpInfo($event_category)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unsubscribeWebhookAsyncWithHttpInfo($event_category)
    {
        $returnType = '';
        $request = $this->unsubscribeWebhookRequest($event_category);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function unsubscribeWebhookRequest($event_category)
    {
        // verify the required parameter 'event_category' is set
        if ($event_category === null || (is_array($event_category) && count($event_category) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $event_category when calling unsubscribeWebhook'
            );
        }

        $resourcePath = '/webhook/subscription/{eventCategory}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
