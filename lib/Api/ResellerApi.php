...
class ResellerApi
{
     ...
     *
     * @param  \TCR\Client\Model\Reseller $body Reseller to be created (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\Reseller
     */
    public function createReseller($body)
    {
        list($response) = $this->createResellerWithHttpInfo($body);
        return $response;
    }
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\Reseller, HTTP status code, HTTP response headers (array of strings)
     */
    public function createResellerWithHttpInfo($body)
    {
        $returnType = '\TCR\Client\Model\Reseller';
        $request = $this->createResellerRequest($body);
     ...
     */
    public function createResellerAsync($body)
    {
        return $this->createResellerAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createResellerAsyncWithHttpInfo($body)
    {
        $returnType = '\TCR\Client\Model\Reseller';
        $request = $this->createResellerRequest($body);
     ...
     */
    protected function createResellerRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createReseller'
            );
        }
     ...
     * Delete reseller
     *
     * @param  string $reseller_id Alphanumeric identifier (prefixed with letter &#x27;R&#x27;) returned from the reseller creation operation. (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    {
        $this->deleteResellerWithHttpInfo($reseller_id);
    }
     ...
     */
    public function deleteResellerWithHttpInfo($reseller_id)
    {
        $returnType = '';
        $request = $this->deleteResellerRequest($reseller_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteResellerAsync($reseller_id)
    {
        return $this->deleteResellerAsyncWithHttpInfo($reseller_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteResellerAsyncWithHttpInfo($reseller_id)
    {
        $returnType = '';
        $request = $this->deleteResellerRequest($reseller_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteResellerRequest($reseller_id)
    {
        // verify the required parameter 'reseller_id' is set
        if ($reseller_id === null || (is_array($reseller_id) && count($reseller_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $reseller_id when calling deleteReseller'
            );
        }

        $resourcePath = '/reseller/{resellerId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getResellerWithHttpInfo($reseller_id);
        return $response;
    }
     ...
     * @return array of \TCR\Client\Model\Reseller, HTTP status code, HTTP response headers (array of strings)
     */
    public function getResellerWithHttpInfo($reseller_id)
    {
        $returnType = '\TCR\Client\Model\Reseller';
        $request = $this->getResellerRequest($reseller_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getResellerAsync($reseller_id)
    {
        return $this->getResellerAsyncWithHttpInfo($reseller_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getResellerAsyncWithHttpInfo($reseller_id)
    {
        $returnType = '\TCR\Client\Model\Reseller';
        $request = $this->getResellerRequest($reseller_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getResellerRequest($reseller_id)
    {
        // verify the required parameter 'reseller_id' is set
        if ($reseller_id === null || (is_array($reseller_id) && count($reseller_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $reseller_id when calling getReseller'
            );
        }
    ...
    /**
     * Operation listResellers
     *
     * Search resellers
     *
     * @param  string $company_name Business name of the reseller or DBA. Partial spelling accepted. (optional)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\ResellerRecordSet
     */
    public function listResellers($company_name = null, $page = '1', $records_per_page = '10')
    {
        list($response) = $this->listResellersWithHttpInfo($company_name, $page, $records_per_page);
        return $response;
    }

    /**
     * Operation listResellersWithHttpInfo
     *
     * Search resellers
     *
     * @param  string $company_name Business name of the reseller or DBA. Partial spelling accepted. (optional)
     ...
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \TCR\Client\Model\ResellerRecordSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function listResellersWithHttpInfo($company_name = null, $page = '1', $records_per_page = '10')
    {
        $returnType = '\TCR\Client\Model\ResellerRecordSet';
        $request = $this->listResellersRequest($company_name, $page, $records_per_page);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\TCR\Client\Model\ResellerRecordSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listResellersAsync($company_name = null, $page = '1', $records_per_page = '10')
    {
        return $this->listResellersAsyncWithHttpInfo($company_name, $page, $records_per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listResellersAsyncWithHttpInfo
     *
     * Search resellers
     *
     * @param  string $company_name Business name of the reseller or DBA. Partial spelling accepted. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listResellersAsyncWithHttpInfo($company_name = null, $page = '1', $records_per_page = '10')
    {
        $returnType = '\TCR\Client\Model\ResellerRecordSet';
        $request = $this->listResellersRequest($company_name, $page, $records_per_page);
    ...
    /**
     * Create request for operation 'listResellers'
     *
     * @param  string $company_name Business name of the reseller or DBA. Partial spelling accepted. (optional)
     * @param  int $page (optional, default to 1)
     * @param  int $records_per_page Number of records per page. Max size is 500 (optional, default to 10)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listResellersRequest($company_name = null, $page = '1', $records_per_page = '10')
    {
     ...
     * Update reseller
     *
     * @param  \TCR\Client\Model\UpdateReseller $body Reseller properties to be updated (required)
     * @param  string $reseller_id Alphanumeric identifier (prefixed with letter &#x27;R&#x27;) returned from reseller creation operation. (required)
     *
     * @throws \TCR\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TCR\Client\Model\Reseller
     */
    public function updateReseller($body, $reseller_id)
    {
        list($response) = $this->updateResellerWithHttpInfo($body, $reseller_id);
        return $response;
    }
     ...
     * @return array of \TCR\Client\Model\Reseller, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateResellerWithHttpInfo($body, $reseller_id)
    {
        $returnType = '\TCR\Client\Model\Reseller';
        $request = $this->updateResellerRequest($body, $reseller_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateResellerAsync($body, $reseller_id)
    {
        return $this->updateResellerAsyncWithHttpInfo($body, $reseller_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateResellerAsyncWithHttpInfo($body, $reseller_id)
    {
        $returnType = '\TCR\Client\Model\Reseller';
        $request = $this->updateResellerRequest($body, $reseller_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateResellerRequest($body, $reseller_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($reseller_id === null || (is_array($reseller_id) && count($reseller_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $reseller_id when calling updateReseller'
            );
        }
