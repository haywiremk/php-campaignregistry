...
/**
 * ErrorCodeApi Class Doc Comment
 *
 * @category Class
 * @package  TCR\Client
 * @author   Swagger Codegen team
...
class ErrorCodeApi
{
    ...
    {
        $this->listErrorCodesWithHttpInfo();
    }

    /**
     * Operation listErrorCodesWithHttpInfo
     *
     * List all error codes
     *
     *
     ...
     */
    public function listErrorCodesWithHttpInfo()
    {
        $returnType = '';
        $request = $this->listErrorCodesRequest();
     ...
     */
    public function listErrorCodesAsync()
    {
        return $this->listErrorCodesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listErrorCodesAsyncWithHttpInfo
     *
     * List all error codes
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listErrorCodesAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->listErrorCodesRequest();
    ...
    /**
     * Create request for operation 'listErrorCodes'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listErrorCodesRequest()
    {
